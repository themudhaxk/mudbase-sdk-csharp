...
# **GetFeeSettings**
> TestIntegration200Response GetFeeSettings (string projectId)
...
{
    // ~~Get project fee settings~~ (deprecated)
    ApiResponse<TestIntegration200Response> response = apiInstance.GetFeeSettingsWithHttpInfo(projectId);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}

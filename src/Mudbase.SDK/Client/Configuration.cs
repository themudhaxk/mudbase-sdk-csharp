...
namespace Mudbase.SDK.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.3.16/csharp");
        ...
        public Configuration(
            ...
            string basePath = "https://cloud.mudbase.dev") : this()
        {
        ...
        {
            string report = "C# SDK (Mudbase.SDK) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 1.3.16\n";

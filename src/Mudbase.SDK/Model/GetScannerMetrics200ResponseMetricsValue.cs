...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getScannerMetrics_200_response_metrics_value")]
    public partial class GetScannerMetrics200ResponseMetricsValue : IValidatableObject
    {
        ...
        public GetScannerMetrics200ResponseMetricsValue(decimal? lastScannedBlock = default, decimal? currentBlock = default, decimal? lag = default, DateTime? lastUpdated = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "lastScannedBlock", EmitDefaultValue = true)]
        public decimal? LastScannedBlock { get; set; }

        /// <summary>
        /// Gets or Sets CurrentBlock
        /// </summary>
        [DataMember(Name = "currentBlock", EmitDefaultValue = true)]
        public decimal? CurrentBlock { get; set; }

        /// <summary>
        /// Gets or Sets Lag
        /// </summary>
        [DataMember(Name = "lag", EmitDefaultValue = true)]

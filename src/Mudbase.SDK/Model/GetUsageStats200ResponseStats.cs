...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getUsageStats_200_response_stats")]
    public partial class GetUsageStats200ResponseStats : IValidatableObject
    {
        ...
        public GetUsageStats200ResponseStats(int totalCalls = default, int successCalls = default, int failedCalls = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "totalCalls", EmitDefaultValue = false)]
        public int TotalCalls { get; set; }

        /// <summary>
        /// Gets or Sets SuccessCalls
        /// </summary>
        [DataMember(Name = "successCalls", EmitDefaultValue = false)]
        public int SuccessCalls { get; set; }

        /// <summary>
        /// Gets or Sets FailedCalls
        /// </summary>
        [DataMember(Name = "failedCalls", EmitDefaultValue = false)]

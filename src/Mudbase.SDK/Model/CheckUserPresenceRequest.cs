...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "checkUserPresence_request")]
    public partial class CheckUserPresenceRequest : IValidatableObject
    {
        ...
        protected CheckUserPresenceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckUserPresenceRequest" /> class.
        /// </summary>
        /// <param name="userIds">userIds (required).</param>
        public CheckUserPresenceRequest(List<string> userIds = default)
        {
            // to ensure "userIds" is required (not null)
            if (userIds == null)
            {
                throw new ArgumentNullException("userIds is a required property for CheckUserPresenceRequest and cannot be null");
            }

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getInvoices_200_response_invoices_inner")]
    public partial class GetInvoices200ResponseInvoicesInner : IValidatableObject
    {
        ...
        public GetInvoices200ResponseInvoicesInner(string id = default, string invoiceNumber = default, string status = default, decimal total = default, string currency = default, DateTime? dueDate = default, DateTime? paidAt = default, DateTime createdAt = default, string hostedInvoiceUrl = default)
        {
            this.Id = id;
        ...
        /// </summary>
        [DataMember(Name = "hostedInvoiceUrl", EmitDefaultValue = true)]

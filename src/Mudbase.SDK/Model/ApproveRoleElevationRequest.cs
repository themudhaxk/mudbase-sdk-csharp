...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "approveRoleElevation_request")]
    public partial class ApproveRoleElevationRequest : IValidatableObject
    {
        ...
        protected ApproveRoleElevationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproveRoleElevationRequest" /> class.
        /// </summary>
        /// <param name="approved">approved (required).</param>
        /// <param name="reason">Required if approved is false.</param>
        public ApproveRoleElevationRequest(bool approved = default, string reason = default)
        {

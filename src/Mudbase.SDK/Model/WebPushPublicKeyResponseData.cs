...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebPushPublicKeyResponse_data")]
    public partial class WebPushPublicKeyResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebPushPublicKeyResponseData" /> class.
        /// </summary>
        /// <param name="enabled">enabled.</param>
        /// <param name="publicKey">The VAPID application-server public key, or null when native Web Push is not enabled. .</param>
        public WebPushPublicKeyResponseData(bool enabled = default, string publicKey = default)
        {
        ...
        /// </summary>
        /// <value>The VAPID application-server public key, or null when native Web Push is not enabled. </value>

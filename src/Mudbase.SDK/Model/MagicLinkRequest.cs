...
namespace Mudbase.SDK.Model
{
    ...
    public partial class MagicLinkRequest : IValidatableObject
    {
        ...
        public MagicLinkRequest(string email = default, string projectId = default, string redirectUrl = default)
        {
            ...
            if (projectId == null)
            {
                throw new ArgumentNullException("projectId is a required property for MagicLinkRequest and cannot be null");
            }

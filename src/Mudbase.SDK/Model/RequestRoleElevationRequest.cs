...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "requestRoleElevation_request")]
    public partial class RequestRoleElevationRequest : IValidatableObject
    {
        ...
        protected RequestRoleElevationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestRoleElevationRequest" /> class.
        /// </summary>
        /// <param name="roleSlug">roleSlug (required).</param>
        public RequestRoleElevationRequest(string roleSlug = default)
        {
            // to ensure "roleSlug" is required (not null)
            if (roleSlug == null)
            {
                throw new ArgumentNullException("roleSlug is a required property for RequestRoleElevationRequest and cannot be null");
            }

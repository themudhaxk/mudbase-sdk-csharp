...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getNetworkStatus_200_response")]
    public partial class GetNetworkStatus200Response : IValidatableObject
    {
        ...
        public GetNetworkStatus200Response(bool success = default, Dictionary<string, GetNetworkStatus200ResponseDataValue> data = default)
        {
        ...
        public Dictionary<string, GetNetworkStatus200ResponseDataValue> Data { get; set; }

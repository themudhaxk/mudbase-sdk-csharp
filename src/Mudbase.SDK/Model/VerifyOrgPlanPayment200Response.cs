...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "verifyOrgPlanPayment_200_response")]
    public partial class VerifyOrgPlanPayment200Response : IValidatableObject
    {
        ...
        public VerifyOrgPlanPayment200Response(bool success = default, string message = default, VerifyOrgPlanPayment200ResponseData data = default)
        {
        ...
        public VerifyOrgPlanPayment200ResponseData Data { get; set; }

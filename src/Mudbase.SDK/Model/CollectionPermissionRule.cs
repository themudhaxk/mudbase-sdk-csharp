...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectionPermissionRule")]
    public partial class CollectionPermissionRule : IValidatableObject
    {
        ...
        public CollectionPermissionRule(List<CollectionAction> actions = default, Object conditions = default)
        {
        ...
        public List<CollectionAction> Actions { get; set; }

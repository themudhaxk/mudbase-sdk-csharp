...
namespace Mudbase.SDK.Model
{
    ...
    public partial class ApiKeyWithSecret : IValidatableObject
    {
        ...
        public ApiKeyWithSecret(string id = default, string name = default, ProjectSummary project = default, List<ApiKeyPermission> permissions = default, RateLimit rateLimit = default, ApiKeyUsage usage = default, bool isActive = default, DateTime expiresAt = default, UserSummary createdBy = default, DateTime createdAt = default, string secret = default)
        {
            this.Id = id;
            this.Name = name;

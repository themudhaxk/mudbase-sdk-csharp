...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "registerLocalUser_201_response_user")]
    public partial class RegisterLocalUser201ResponseUser : IValidatableObject
    {
        ...
        public RegisterLocalUser201ResponseUser(string id = default, string email = default, string firstName = default, string lastName = default, bool emailVerified = default, string customRole = default)
        {
            this.Id = id;
            this.Email = email;

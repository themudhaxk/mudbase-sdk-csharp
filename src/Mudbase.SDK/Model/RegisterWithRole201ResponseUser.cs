...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "registerWithRole_201_response_user")]
    public partial class RegisterWithRole201ResponseUser : IValidatableObject
    {
        ...
        public RegisterWithRole201ResponseUser(string id = default, string email = default, string firstName = default, string lastName = default, string role = default, string customRole = default, bool emailVerified = default)
        {
            this.Id = id;
            this.Email = email;

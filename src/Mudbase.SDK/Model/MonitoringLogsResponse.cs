...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MonitoringLogsResponse")]
    public partial class MonitoringLogsResponse : IValidatableObject
    {
        ...
        public MonitoringLogsResponse(List<MonitoringLogsResponseLogsInner> logs = default, int count = default, int page = default, int limit = default, int total = default, int totalPages = default)
        {
            this.Logs = logs;
            this.Count = count;
            this.Page = page;
        ...
        public List<MonitoringLogsResponseLogsInner> Logs { get; set; }

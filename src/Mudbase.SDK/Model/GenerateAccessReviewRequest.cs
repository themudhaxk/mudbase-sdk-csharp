...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "generateAccessReview_request")]
    public partial class GenerateAccessReviewRequest : IValidatableObject
    {
        ...
        protected GenerateAccessReviewRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateAccessReviewRequest" /> class.
        /// </summary>
        /// <param name="orgId">orgId (required).</param>
        /// <param name="reviewPeriod">reviewPeriod (required).</param>
        public GenerateAccessReviewRequest(string orgId = default, GenerateAccessReviewRequestReviewPeriod reviewPeriod = default)
        {
            // to ensure "orgId" is required (not null)
            if (orgId == null)
            {
                throw new ArgumentNullException("orgId is a required property for GenerateAccessReviewRequest and cannot be null");
            }
            this.OrgId = orgId;
            // to ensure "reviewPeriod" is required (not null)
            if (reviewPeriod == null)
            {
                throw new ArgumentNullException("reviewPeriod is a required property for GenerateAccessReviewRequest and cannot be null");
            }
        ...
        */
        ...
        /// </summary>
        [DataMember(Name = "reviewPeriod", IsRequired = true, EmitDefaultValue = true)]

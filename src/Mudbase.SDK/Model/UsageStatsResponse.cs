...
namespace Mudbase.SDK.Model
{
    ...
    /// UsageStatsResponse
    /// </summary>
    [DataContract(Name = "UsageStatsResponse")]
    public partial class UsageStatsResponse : IValidatableObject
    {
        ...
        public UsageStatsResponse(Usage usage = default, Limits limits = default, Plan plan = default, string period = default, UsageStatsResponsePercentages percentages = default)
        {
            this.Usage = usage;
            this.Limits = limits;
            this.Plan = plan;
        ...
        public UsageStatsResponsePercentages Percentages { get; set; }

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listProjectEmailTemplates_200_response")]
    public partial class ListProjectEmailTemplates200Response : IValidatableObject
    {
        ...
        public ListProjectEmailTemplates200Response(bool success = default, List<EmailTemplateCatalogItem> data = default)
        {
        ...
        public List<EmailTemplateCatalogItem> Data { get; set; }

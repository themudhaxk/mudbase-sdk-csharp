...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getOAuthProviderConfig_200_response_config")]
    public partial class GetOAuthProviderConfig200ResponseConfig : IValidatableObject
    {
        ...
        public GetOAuthProviderConfig200ResponseConfig(string clientId = default, List<string> scope = default)
        {

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DashboardOverviewData_requestVolume14d_inner")]
    public partial class DashboardOverviewDataRequestVolume14dInner : IValidatableObject
    {
        ...
        public DashboardOverviewDataRequestVolume14dInner(string date = default, int apiCalls = default, int latencyTracked = default)
        {
            this.Date = date;
        ...
        */
        ...
        [DataMember(Name = "latencyTracked", EmitDefaultValue = false)]
        public int LatencyTracked { get; set; }

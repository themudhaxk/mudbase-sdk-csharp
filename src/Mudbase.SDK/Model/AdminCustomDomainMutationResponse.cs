...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AdminCustomDomainMutationResponse")]
    public partial class AdminCustomDomainMutationResponse : IValidatableObject
    {
        ...
        protected AdminCustomDomainMutationResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdminCustomDomainMutationResponse" /> class.
        /// </summary>
        /// <param name="success">success (required).</param>
        /// <param name="domain">domain (required).</param>
        public AdminCustomDomainMutationResponse(bool success = default, OrgDomainEntryWithDns domain = default)
        {
            this.Success = success;
            // to ensure "domain" is required (not null)
            if (domain == null)
            {
                throw new ArgumentNullException("domain is a required property for AdminCustomDomainMutationResponse and cannot be null");
            }
            this.Domain = domain;
        }

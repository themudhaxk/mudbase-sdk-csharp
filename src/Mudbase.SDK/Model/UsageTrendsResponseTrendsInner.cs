...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UsageTrendsResponse_trends_inner")]
    public partial class UsageTrendsResponseTrendsInner : IValidatableObject
    {
        ...
        public UsageTrendsResponseTrendsInner(UsageTrendsResponseTrendsInnerId id = default, int apiCalls = default, int storage = default, int bandwidth = default, int dbReads = default, int dbWrites = default)
        {
            this.Id = id;
        ...
        public UsageTrendsResponseTrendsInnerId Id { get; set; }

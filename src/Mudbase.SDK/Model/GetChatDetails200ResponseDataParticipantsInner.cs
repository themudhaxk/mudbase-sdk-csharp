...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getChatDetails_200_response_data_participants_inner")]
    public partial class GetChatDetails200ResponseDataParticipantsInner : IValidatableObject
    {
        ...
        public GetChatDetails200ResponseDataParticipantsInner(string userId = default, string role = default)
        {
            this.UserId = userId;
            this.Role = role;
        }

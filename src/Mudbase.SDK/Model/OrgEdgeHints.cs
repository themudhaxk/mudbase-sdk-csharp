...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrgEdgeHints")]
    public partial class OrgEdgeHints : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgEdgeHints" /> class.
        /// </summary>
        ...
        public OrgEdgeHints(bool saasIntegrationEnabled = default, bool skipped = default, string reason = default, string customHostnameId = default, string hostnameStatus = default, string sslStatus = default, OrgEdgeHintsOwnershipVerification ownershipVerification = default, List<OrgSslValidationRecord> sslValidationRecords = default, string lastError = default, string instructions = default)
        {
        ...
        public OrgEdgeHintsOwnershipVerification OwnershipVerification { get; set; }

        /// <summary>
        /// Gets or Sets SslValidationRecords
        /// </summary>
        [DataMember(Name = "sslValidationRecords", EmitDefaultValue = false)]
        public List<OrgSslValidationRecord> SslValidationRecords { get; set; }

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "resendVerificationAuth_request")]
    public partial class ResendVerificationAuthRequest : IValidatableObject
    {
        ...
        protected ResendVerificationAuthRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResendVerificationAuthRequest" /> class.
        /// </summary>
        /// <param name="email">email (required).</param>
        /// <param name="projectId">Optional; for project-scoped signup (sends link with project context).</param>
        public ResendVerificationAuthRequest(string email = default, string projectId = default)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for ResendVerificationAuthRequest and cannot be null");
            }
            this.Email = email;

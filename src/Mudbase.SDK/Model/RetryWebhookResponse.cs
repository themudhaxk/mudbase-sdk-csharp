...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RetryWebhookResponse")]
    public partial class RetryWebhookResponse : IValidatableObject
    {
        ...
        protected RetryWebhookResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RetryWebhookResponse" /> class.
        /// </summary>
        /// <param name="message">message (required).</param>
        /// <param name="webhookId">Same log _id you passed in the path (required).</param>
        public RetryWebhookResponse(string message = default, string webhookId = default)
        {
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for RetryWebhookResponse and cannot be null");
            }
            this.Message = message;
            // to ensure "webhookId" is required (not null)
            if (webhookId == null)
            {
                throw new ArgumentNullException("webhookId is a required property for RetryWebhookResponse and cannot be null");
            }

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "sendPushNotification_429_response")]
    public partial class SendPushNotification429Response : IValidatableObject
    {
        ...
        public SendPushNotification429Response(bool success = default, string error = default, string message = default)
        {

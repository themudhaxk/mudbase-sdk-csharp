...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getProjectCaptchaConfig_200_response")]
    public partial class GetProjectCaptchaConfig200Response : IValidatableObject
    {
        ...
        public GetProjectCaptchaConfig200Response(GetProjectCaptchaConfig200ResponseCaptcha captcha = default)
        {
        ...
        public GetProjectCaptchaConfig200ResponseCaptcha Captcha { get; set; }

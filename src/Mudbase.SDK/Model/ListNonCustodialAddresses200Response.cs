...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listNonCustodialAddresses_200_response")]
    public partial class ListNonCustodialAddresses200Response : IValidatableObject
    {
        ...
        public ListNonCustodialAddresses200Response(bool success = default, List<NonCustodialAddress> data = default, int count = default)
        {
        ...
        public List<NonCustodialAddress> Data { get; set; }

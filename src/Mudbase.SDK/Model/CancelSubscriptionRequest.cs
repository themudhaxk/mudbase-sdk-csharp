...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cancelSubscription_request")]
    public partial class CancelSubscriptionRequest : IValidatableObject
    {
        ...
        public CancelSubscriptionRequest(bool cancelImmediately = false)
        {
        ...
        [DataMember(Name = "cancelImmediately", EmitDefaultValue = true)]

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "addReaction_200_response")]
    public partial class AddReaction200Response : IValidatableObject
    {
        ...
        public AddReaction200Response(bool success = default, List<AddReaction200ResponseDataInner> data = default)
        {
        ...
        public List<AddReaction200ResponseDataInner> Data { get; set; }

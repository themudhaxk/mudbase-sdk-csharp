...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "markMessagesAsRead_request")]
    public partial class MarkMessagesAsReadRequest : IValidatableObject
    {
        ...
        public MarkMessagesAsReadRequest(List<string> messageIds = default)
        {
            // to ensure "messageIds" is required (not null)
            if (messageIds == null)
            {
                throw new ArgumentNullException("messageIds is a required property for MarkMessagesAsReadRequest and cannot be null");
            }

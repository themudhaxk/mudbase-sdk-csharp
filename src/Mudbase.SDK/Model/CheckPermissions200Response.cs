...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "checkPermissions_200_response")]
    public partial class CheckPermissions200Response : IValidatableObject
    {
        ...
        public CheckPermissions200Response(Object user = default, CheckPermissions200ResponsePermissions permissions = default)
        {
            this.User = user;
        ...
        public CheckPermissions200ResponsePermissions Permissions { get; set; }

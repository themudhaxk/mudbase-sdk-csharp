...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "patchProjectFcmConfig_request_oneOf")]
    public partial class PatchProjectFcmConfigRequestOneOf : IValidatableObject
    {
        ...
        protected PatchProjectFcmConfigRequestOneOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchProjectFcmConfigRequestOneOf" /> class.
        /// </summary>
        /// <param name="serviceAccountJson">Firebase service account JSON (client_email, private_key, etc.) (required).</param>
        public PatchProjectFcmConfigRequestOneOf(Object serviceAccountJson = default)
        {
            // to ensure "serviceAccountJson" is required (not null)
            if (serviceAccountJson == null)
            {
                throw new ArgumentNullException("serviceAccountJson is a required property for PatchProjectFcmConfigRequestOneOf and cannot be null");
            }
        ...
        [DataMember(Name = "serviceAccountJson", IsRequired = true, EmitDefaultValue = true)]

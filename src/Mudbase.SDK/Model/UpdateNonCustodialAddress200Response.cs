...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateNonCustodialAddress_200_response")]
    public partial class UpdateNonCustodialAddress200Response : IValidatableObject
    {
        ...
        public UpdateNonCustodialAddress200Response(bool success = default, string message = default, NonCustodialAddressResponse data = default)
        {
        ...
        public NonCustodialAddressResponse Data { get; set; }

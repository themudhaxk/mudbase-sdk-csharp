...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "confirmAddressVerification_request")]
    public partial class ConfirmAddressVerificationRequest : IValidatableObject
    {
        ...
        protected ConfirmAddressVerificationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfirmAddressVerificationRequest" /> class.
        /// </summary>
        /// <param name="txHash">txHash (required).</param>
        public ConfirmAddressVerificationRequest(string txHash = default)
        {
            // to ensure "txHash" is required (not null)
            if (txHash == null)
            {
                throw new ArgumentNullException("txHash is a required property for ConfirmAddressVerificationRequest and cannot be null");
            }
            this.TxHash = txHash;
        }

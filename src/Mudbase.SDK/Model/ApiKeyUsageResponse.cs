...
namespace Mudbase.SDK.Model
{
    ...
    /// ApiKeyUsageResponse
    /// </summary>
    [DataContract(Name = "ApiKeyUsageResponse")]
    public partial class ApiKeyUsageResponse : IValidatableObject
    {
        ...
        public ApiKeyUsageResponse(ApiKeyUsage usage = default, RateLimit rateLimit = default, bool isActive = default, DateTime expiresAt = default)
        {
            this.Usage = usage;

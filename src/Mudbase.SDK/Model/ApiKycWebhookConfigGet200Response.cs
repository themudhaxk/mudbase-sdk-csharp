...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_kyc_webhook_config_get_200_response")]
    public partial class ApiKycWebhookConfigGet200Response : IValidatableObject
    {
        ...
        public ApiKycWebhookConfigGet200Response(string webhookUrl = default, bool secretSet = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "secretSet", EmitDefaultValue = true)]

...
namespace Mudbase.SDK.Model
{
    ...
    public partial class Bucket : IValidatableObject
    {
        ...
        public Bucket(string id = default, string name = default, string projectId = default, bool isPublic = default, DateTime createdAt = default, DateTime updatedAt = default)
        {
            this.Id = id;
            this.Name = name;

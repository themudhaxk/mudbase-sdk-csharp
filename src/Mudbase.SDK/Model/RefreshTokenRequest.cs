...
namespace Mudbase.SDK.Model
{
    ...
    /// RefreshTokenRequest
    /// </summary>
    [DataContract(Name = "refreshToken_request")]
    public partial class RefreshTokenRequest : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="RefreshTokenRequest" /> class.
        /// </summary>
        /// <param name="refreshToken">The refresh token returned from login/sign-in (org or project) (required).</param>
        public RefreshTokenRequest(string refreshToken = default)
        {

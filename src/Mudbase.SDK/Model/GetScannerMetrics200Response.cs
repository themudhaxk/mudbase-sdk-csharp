...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getScannerMetrics_200_response")]
    public partial class GetScannerMetrics200Response : IValidatableObject
    {
        ...
        public GetScannerMetrics200Response(Dictionary<string, GetScannerMetrics200ResponseMetricsValue> metrics = default, decimal lagAlertThreshold = default, List<GetScannerMetrics200ResponseAlertsInner> alerts = default)
        {
        ...
        public Dictionary<string, GetScannerMetrics200ResponseMetricsValue> Metrics { get; set; }

        /// <summary>
        /// Block lag threshold above which alerts are raised
        /// </summary>
        /// <value>Block lag threshold above which alerts are raised</value>
        [DataMember(Name = "lagAlertThreshold", EmitDefaultValue = false)]
        public decimal LagAlertThreshold { get; set; }

        /// <summary>
        /// Gets or Sets Alerts
        /// </summary>
        [DataMember(Name = "alerts", EmitDefaultValue = false)]
        public List<GetScannerMetrics200ResponseAlertsInner> Alerts { get; set; }

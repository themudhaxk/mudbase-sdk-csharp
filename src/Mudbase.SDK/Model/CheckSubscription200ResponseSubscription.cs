...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "checkSubscription_200_response_subscription")]
    public partial class CheckSubscription200ResponseSubscription : IValidatableObject
    {
        ...
        public CheckSubscription200ResponseSubscription(string status = default, string plan = default)
        {
            this.Status = status;
            this.Plan = plan;
        }

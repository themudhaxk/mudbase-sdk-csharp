...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "validatePasswordResetToken_request")]
    public partial class ValidatePasswordResetTokenRequest : IValidatableObject
    {
        ...
        protected ValidatePasswordResetTokenRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatePasswordResetTokenRequest" /> class.
        /// </summary>
        /// <param name="token">Token from the reset link query parameter (required).</param>
        public ValidatePasswordResetTokenRequest(string token = default)
        {
            // to ensure "token" is required (not null)
            if (token == null)
            {
                throw new ArgumentNullException("token is a required property for ValidatePasswordResetTokenRequest and cannot be null");
            }
            this.Token = token;
        }

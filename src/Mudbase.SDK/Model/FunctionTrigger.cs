...
namespace Mudbase.SDK.Model
{
    ...
    public partial class FunctionTrigger : IValidatableObject
    {
        ...
        /// <param name="varEvent">Event name (e.g. create, update, delete for document; uploaded, deleted for file).</param>
        ...
        /// </summary>
        /// <value>Event name (e.g. create, update, delete for document; uploaded, deleted for file)</value>

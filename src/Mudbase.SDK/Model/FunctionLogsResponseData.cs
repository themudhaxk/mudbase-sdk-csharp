...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FunctionLogsResponse_data")]
    public partial class FunctionLogsResponseData : IValidatableObject
    {
        ...
        public FunctionLogsResponseData(List<FunctionExecution> executions = default, FunctionStats stats = default)
        {
        ...
        public List<FunctionExecution> Executions { get; set; }

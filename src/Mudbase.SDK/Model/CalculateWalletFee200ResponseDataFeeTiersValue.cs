...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "calculateWalletFee_200_response_data_feeTiers_value")]
    public partial class CalculateWalletFee200ResponseDataFeeTiersValue : IValidatableObject
    {
        ...
        public CalculateWalletFee200ResponseDataFeeTiersValue(decimal gasPriceGwei = default, string networkFee = default)
        {

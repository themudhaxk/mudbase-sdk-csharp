...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "eraseUserData_request")]
    public partial class EraseUserDataRequest : IValidatableObject
    {
        ...
        */
        ...
        protected EraseUserDataRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EraseUserDataRequest" /> class.
        /// </summary>
        ...
        public EraseUserDataRequest(ConfirmEnum confirm = default, string currentPassword = default, string totpToken = default)
        {

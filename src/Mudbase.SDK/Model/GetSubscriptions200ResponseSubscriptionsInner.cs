...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getSubscriptions_200_response_subscriptions_inner")]
    public partial class GetSubscriptions200ResponseSubscriptionsInner : IValidatableObject
    {
        ...
        public GetSubscriptions200ResponseSubscriptionsInner(string id = default, string status = default)
        {
            this.Id = id;
            this.Status = status;
        }

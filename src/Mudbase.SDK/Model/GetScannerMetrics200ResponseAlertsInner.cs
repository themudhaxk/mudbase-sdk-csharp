...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getScannerMetrics_200_response_alerts_inner")]
    public partial class GetScannerMetrics200ResponseAlertsInner : IValidatableObject
    {
        ...
        public GetScannerMetrics200ResponseAlertsInner(string chain = default, decimal lag = default, decimal threshold = default)
        {
            this.Chain = chain;
            this.Lag = lag;

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "verifyOrgPlanPayment_200_response_data")]
    public partial class VerifyOrgPlanPayment200ResponseData : IValidatableObject
    {
        ...
        public VerifyOrgPlanPayment200ResponseData(string plan = default, string billingCycle = default, string orgId = default)
        {
            this.Plan = plan;

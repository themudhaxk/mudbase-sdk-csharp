...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceUnregisteredResponse_data")]
    public partial class DeviceUnregisteredResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceUnregisteredResponseData" /> class.
        /// </summary>
        /// <param name="removed">True if a matching token was removed; false if none was registered..</param>
        public DeviceUnregisteredResponseData(bool removed = default)
        {
        ...
        /// </summary>
        /// <value>True if a matching token was removed; false if none was registered.</value>

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AdminApproveOrgDomainCnameRequest")]
    public partial class AdminApproveOrgDomainCnameRequest : IValidatableObject
    {
        ...
        public AdminApproveOrgDomainCnameRequest(bool verifyDns = default)
        {
        ...
        [DataMember(Name = "verifyDns", EmitDefaultValue = true)]
        public bool VerifyDns { get; set; }

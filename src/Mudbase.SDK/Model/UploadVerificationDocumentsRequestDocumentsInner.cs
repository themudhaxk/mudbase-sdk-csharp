...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "uploadVerificationDocuments_request_documents_inner")]
    public partial class UploadVerificationDocumentsRequestDocumentsInner : IValidatableObject
    {
        ...
        public UploadVerificationDocumentsRequestDocumentsInner(string type = default, string url = default)
        {
            this.Type = type;
            this.Url = url;
        }

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createChat_201_response_data")]
    public partial class CreateChat201ResponseData : IValidatableObject
    {
        ...
        public CreateChat201ResponseData(string id = default, string name = default, string type = default, List<string> participants = default, DateTime createdAt = default)
        {
            this.Id = id;
            this.Name = name;
            this.Type = type;

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "setOrgPrimaryDomain_request")]
    public partial class SetOrgPrimaryDomainRequest : IValidatableObject
    {
        ...
        protected SetOrgPrimaryDomainRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SetOrgPrimaryDomainRequest" /> class.
        /// </summary>
        /// <param name="hostname">hostname (required).</param>
        public SetOrgPrimaryDomainRequest(string hostname = default)
        {
            // to ensure "hostname" is required (not null)
            if (hostname == null)
            {
                throw new ArgumentNullException("hostname is a required property for SetOrgPrimaryDomainRequest and cannot be null");
            }

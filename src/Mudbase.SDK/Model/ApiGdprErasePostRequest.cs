...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_gdpr_erase_post_request")]
    public partial class ApiGdprErasePostRequest : IValidatableObject
    {
        ...
        protected ApiGdprErasePostRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiGdprErasePostRequest" /> class.
        /// </summary>
        /// <param name="confirm">Must equal \&quot;DELETE\&quot; to proceed with erasure. (required).</param>
        ...
        public ApiGdprErasePostRequest(ConfirmEnum confirm = default, string currentPassword = default, string totpToken = default)
        {
        ...
        */
        [DataMember(Name = "totpToken", EmitDefaultValue = false)]

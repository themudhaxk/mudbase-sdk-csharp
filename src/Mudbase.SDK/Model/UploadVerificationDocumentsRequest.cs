...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "uploadVerificationDocuments_request")]
    public partial class UploadVerificationDocumentsRequest : IValidatableObject
    {
        ...
        protected UploadVerificationDocumentsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadVerificationDocumentsRequest" /> class.
        /// </summary>
        /// <param name="roleSlug">roleSlug (required).</param>
        /// <param name="documents">documents (required).</param>
        public UploadVerificationDocumentsRequest(string roleSlug = default, List<UploadVerificationDocumentsRequestDocumentsInner> documents = default)
        {
            // to ensure "roleSlug" is required (not null)
            if (roleSlug == null)
            {
                throw new ArgumentNullException("roleSlug is a required property for UploadVerificationDocumentsRequest and cannot be null");
            }
            this.RoleSlug = roleSlug;
            // to ensure "documents" is required (not null)
            if (documents == null)
            {
                throw new ArgumentNullException("documents is a required property for UploadVerificationDocumentsRequest and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "roleSlug", IsRequired = true, EmitDefaultValue = true)]

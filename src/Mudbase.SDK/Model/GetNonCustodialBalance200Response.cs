...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getNonCustodialBalance_200_response")]
    public partial class GetNonCustodialBalance200Response : IValidatableObject
    {
        ...
        public GetNonCustodialBalance200Response(bool success = default, WalletBalance data = default)
        {
        ...
        public WalletBalance Data { get; set; }

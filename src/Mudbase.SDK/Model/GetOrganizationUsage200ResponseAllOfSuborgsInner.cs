...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getOrganizationUsage_200_response_allOf_suborgs_inner")]
    public partial class GetOrganizationUsage200ResponseAllOfSuborgsInner : IValidatableObject
    {
        ...
        public GetOrganizationUsage200ResponseAllOfSuborgsInner(string id = default, string name = default, string slug = default, Usage usage = default)
        {
            this.Id = id;
            this.Name = name;
            this.Slug = slug;

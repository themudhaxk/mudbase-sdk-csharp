...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrgDnsInstructionsResponse")]
    public partial class OrgDnsInstructionsResponse : IValidatableObject
    {
        ...
        protected OrgDnsInstructionsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgDnsInstructionsResponse" /> class.
        /// </summary>
        ...
        public OrgDnsInstructionsResponse(bool success = default, OrgDomainEntryOrgConsole domain = default, string dnsVerificationInstructions = default)
        {
            this.Success = success;
            // to ensure "domain" is required (not null)
            if (domain == null)
            {
                throw new ArgumentNullException("domain is a required property for OrgDnsInstructionsResponse and cannot be null");
            }
            this.Domain = domain;

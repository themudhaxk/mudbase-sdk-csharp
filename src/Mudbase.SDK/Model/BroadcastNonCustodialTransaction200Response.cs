...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "broadcastNonCustodialTransaction_200_response")]
    public partial class BroadcastNonCustodialTransaction200Response : IValidatableObject
    {
        ...
        public BroadcastNonCustodialTransaction200Response(bool success = default, string message = default, BroadcastNonCustodialTransaction200ResponseData data = default)
        {
        ...
        public BroadcastNonCustodialTransaction200ResponseData Data { get; set; }

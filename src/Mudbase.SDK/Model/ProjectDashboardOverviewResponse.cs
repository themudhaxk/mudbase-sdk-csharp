...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectDashboardOverviewResponse")]
    public partial class ProjectDashboardOverviewResponse : IValidatableObject
    {
        ...
        protected ProjectDashboardOverviewResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectDashboardOverviewResponse" /> class.
        /// </summary>
        /// <param name="success">success (required).</param>
        /// <param name="data">data (required).</param>
        public ProjectDashboardOverviewResponse(bool success = default, DashboardOverviewData data = default)
        {
            this.Success = success;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ProjectDashboardOverviewResponse and cannot be null");
            }
            this.Data = data;
        }

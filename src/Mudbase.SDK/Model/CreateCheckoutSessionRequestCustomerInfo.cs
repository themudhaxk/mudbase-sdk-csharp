...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createCheckoutSession_request_customerInfo")]
    public partial class CreateCheckoutSessionRequestCustomerInfo : IValidatableObject
    {
        ...
        protected CreateCheckoutSessionRequestCustomerInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCheckoutSessionRequestCustomerInfo" /> class.
        /// </summary>
        /// <param name="email">email (required).</param>
        /// <param name="name">name.</param>
        public CreateCheckoutSessionRequestCustomerInfo(string email = default, string name = default)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for CreateCheckoutSessionRequestCustomerInfo and cannot be null");
            }
            this.Email = email;
            this.Name = name;
        }

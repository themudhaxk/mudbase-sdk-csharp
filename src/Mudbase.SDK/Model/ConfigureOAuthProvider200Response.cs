...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "configureOAuthProvider_200_response")]
    public partial class ConfigureOAuthProvider200Response : IValidatableObject
    {
        ...
        public ConfigureOAuthProvider200Response(string message = default, ConfigureOAuthProvider200ResponseProvider provider = default)
        {
        ...
        */
        ...
        public ConfigureOAuthProvider200ResponseProvider Provider { get; set; }

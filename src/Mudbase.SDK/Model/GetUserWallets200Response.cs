...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getUserWallets_200_response")]
    public partial class GetUserWallets200Response : IValidatableObject
    {
        ...
        public GetUserWallets200Response(bool success = default, List<CreateWallet201ResponseData> data = default)
        {
        ...
        public List<CreateWallet201ResponseData> Data { get; set; }

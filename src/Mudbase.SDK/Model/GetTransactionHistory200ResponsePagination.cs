...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getTransactionHistory_200_response_pagination")]
    public partial class GetTransactionHistory200ResponsePagination : IValidatableObject
    {
        ...
        public GetTransactionHistory200ResponsePagination(int page = default, int limit = default, int count = default, int total = default, int totalPages = default, bool hasNextPage = default, bool hasPreviousPage = default)
        {
            this.Page = page;
            this.Limit = limit;
            this.Count = count;

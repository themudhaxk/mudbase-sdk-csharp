...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PushSentResponse_data_channels")]
    public partial class PushSentResponseDataChannels : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PushSentResponseDataChannels" /> class.
        /// </summary>
        /// <param name="fcm">fcm.</param>
        /// <param name="webPush">webPush.</param>
        public PushSentResponseDataChannels(PushSentResponseDataChannelsFcm fcm = default, PushSentResponseDataChannelsWebPush webPush = default)
        {
            this.Fcm = fcm;
        ...
        public PushSentResponseDataChannelsFcm Fcm { get; set; }

        /// <summary>
        /// Gets or Sets WebPush
        /// </summary>
        [DataMember(Name = "webPush", EmitDefaultValue = true)]
        public PushSentResponseDataChannelsWebPush WebPush { get; set; }

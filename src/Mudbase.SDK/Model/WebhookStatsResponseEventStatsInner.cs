...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookStatsResponse_eventStats_inner")]
    public partial class WebhookStatsResponseEventStatsInner : IValidatableObject
    {
        ...
        public WebhookStatsResponseEventStatsInner(string id = default, int count = default, decimal successRate = default)
        {
            this.Id = id;
            this.Count = count;

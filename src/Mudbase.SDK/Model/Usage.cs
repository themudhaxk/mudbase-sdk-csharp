...
namespace Mudbase.SDK.Model
{
    ...
    public partial class Usage : IValidatableObject
    {
        ...
        public Usage(int projects = default, int users = default, int storage = default, int bandwidth = default, int apiCalls = default, int dbReads = default, int dbWrites = default)
        {

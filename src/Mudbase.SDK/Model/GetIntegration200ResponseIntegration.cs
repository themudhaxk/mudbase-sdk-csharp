...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getIntegration_200_response_integration")]
    public partial class GetIntegration200ResponseIntegration : IValidatableObject
    {
        ...
        public GetIntegration200ResponseIntegration(string id = default, string name = default, string provider = default, string project = default, string status = default, Object config = default, DateTime createdAt = default)
        {
            this.Id = id;
            this.Name = name;

...
namespace Mudbase.SDK.Model
{
    ...
    /// AddOrgDomainRequest
    /// </summary>
    [DataContract(Name = "AddOrgDomainRequest")]
    public partial class AddOrgDomainRequest : IValidatableObject
    {
        ...
        protected AddOrgDomainRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddOrgDomainRequest" /> class.
        /// </summary>
        /// <param name="hostname">hostname (required).</param>
        /// <param name="setPrimary">setPrimary.</param>
        public AddOrgDomainRequest(string hostname = default, bool setPrimary = default)
        {
            // to ensure "hostname" is required (not null)
            if (hostname == null)
            {
                throw new ArgumentNullException("hostname is a required property for AddOrgDomainRequest and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "setPrimary", EmitDefaultValue = true)]

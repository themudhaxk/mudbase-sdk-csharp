...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getEventThroughput_200_response")]
    public partial class GetEventThroughput200Response : IValidatableObject
    {
        ...
        public GetEventThroughput200Response(int windowMs = default, int totalEvents = default, decimal eventsPerSecond = default, Dictionary<string, int> byType = default, DateTime timestamp = default)
        {
        ...
        */
        [DataMember(Name = "windowMs", EmitDefaultValue = false)]
        ...
        */
        [DataMember(Name = "eventsPerSecond", EmitDefaultValue = false)]
        public decimal EventsPerSecond { get; set; }

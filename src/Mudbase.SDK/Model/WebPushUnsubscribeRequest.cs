...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebPushUnsubscribeRequest")]
    public partial class WebPushUnsubscribeRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebPushUnsubscribeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebPushUnsubscribeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebPushUnsubscribeRequest" /> class.
        /// </summary>
        /// <param name="endpoint">The push-service endpoint of the subscription to remove. (required).</param>
        public WebPushUnsubscribeRequest(string endpoint = default)
        {
            // to ensure "endpoint" is required (not null)
            if (endpoint == null)
            {
                throw new ArgumentNullException("endpoint is a required property for WebPushUnsubscribeRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The push-service endpoint of the subscription to remove.</value>

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getUsageWarnings_200_response_warnings_inner")]
    public partial class GetUsageWarnings200ResponseWarningsInner : IValidatableObject
    {
        ...
        public GetUsageWarnings200ResponseWarningsInner(string resource = default, decimal threshold = default, decimal current = default, decimal limit = default, string message = default)
        {

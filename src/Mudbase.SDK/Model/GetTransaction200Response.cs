...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getTransaction_200_response")]
    public partial class GetTransaction200Response : IValidatableObject
    {
        ...
        public GetTransaction200Response(bool success = default, GetTransaction200ResponseData data = default)
        {
        ...
        public GetTransaction200ResponseData Data { get; set; }

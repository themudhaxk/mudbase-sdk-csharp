...
namespace Mudbase.SDK.Model
{
    ...
    public partial class CreateFunctionRequest : IValidatableObject
    {
        ...
        /// <param name="code">Function body (async, has access to payload, db, files, messaging, utils, env, console) (required).</param>
        ...
        /// </summary>
        /// <value>Function body (async, has access to payload, db, files, messaging, utils, env, console)</value>

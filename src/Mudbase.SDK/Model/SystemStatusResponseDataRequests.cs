...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemStatusResponse_data_requests")]
    public partial class SystemStatusResponseDataRequests : IValidatableObject
    {
        ...
        public SystemStatusResponseDataRequests(int total = default, int successful = default, int errors = default, decimal errorRate = default)
        {
            this.Total = total;

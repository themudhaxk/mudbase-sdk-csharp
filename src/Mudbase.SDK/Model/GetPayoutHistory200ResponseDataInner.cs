...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getPayoutHistory_200_response_data_inner")]
    public partial class GetPayoutHistory200ResponseDataInner : IValidatableObject
    {
        ...
        public GetPayoutHistory200ResponseDataInner(string id = default, string currency = default, decimal grossAmount = default, decimal networkFee = default, decimal netAmount = default, string toAddress = default, string txHash = default, string status = default, DateTime createdAt = default)
        {
            this.Id = id;

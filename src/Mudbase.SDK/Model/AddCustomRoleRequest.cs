...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "addCustomRole_request")]
    public partial class AddCustomRoleRequest : IValidatableObject
    {
        ...
        protected AddCustomRoleRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddCustomRoleRequest" /> class.
        /// </summary>
        ...
        /// <param name="signupEndpoint">signupEndpoint (required).</param>
        ...
        public AddCustomRoleRequest(string slug = default, string name = default, string description = default, string signupEndpoint = default, bool requiresApproval = default, bool requiresPayment = default, bool requiresKYC = default, List<AddCustomRoleRequestDefaultPermissionsInner> defaultPermissions = default, Dictionary<string, CreateRoleRequestCollectionPermissionsValue> collectionPermissions = default, Object metadata = default, Dictionary<string, Dictionary<string, bool>> featurePermissions = default)
        {
            // to ensure "slug" is required (not null)
            if (slug == null)
            {
                throw new ArgumentNullException("slug is a required property for AddCustomRoleRequest and cannot be null");
            }
            this.Slug = slug;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AddCustomRoleRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "signupEndpoint" is required (not null)
            if (signupEndpoint == null)
            {
                throw new ArgumentNullException("signupEndpoint is a required property for AddCustomRoleRequest and cannot be null");
            }
        ...
        */
        ...
        <example>seller</example>
        */
        [DataMember(Name = "signupEndpoint", IsRequired = true, EmitDefaultValue = true)]
        ...
        */
        ...
        public List<AddCustomRoleRequestDefaultPermissionsInner> DefaultPermissions { get; set; }

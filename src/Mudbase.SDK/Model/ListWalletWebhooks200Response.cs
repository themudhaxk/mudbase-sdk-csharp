...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listWalletWebhooks_200_response")]
    public partial class ListWalletWebhooks200Response : IValidatableObject
    {
        ...
        public ListWalletWebhooks200Response(bool success = default, List<WalletWebhook> data = default, int count = default)
        {
        ...
        public List<WalletWebhook> Data { get; set; }

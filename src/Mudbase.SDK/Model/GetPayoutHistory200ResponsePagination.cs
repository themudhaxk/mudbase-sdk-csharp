...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getPayoutHistory_200_response_pagination")]
    public partial class GetPayoutHistory200ResponsePagination : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPayoutHistory200ResponsePagination" /> class.
        /// </summary>
        ...
        public GetPayoutHistory200ResponsePagination(int page = default, int limit = default, int count = default, int total = default, int totalPages = default, bool hasNextPage = default, bool hasPreviousPage = default)
        {
            this.Page = page;
            this.Limit = limit;
            this.Count = count;

...
namespace Mudbase.SDK.Model
{
    ...
    public partial class InviteMemberRequest : IValidatableObject
    {
        ...
        public InviteMemberRequest(string email = default, RoleEnum role = default)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for InviteMemberRequest and cannot be null");
            }
            this.Email = email;
            this.Role = role;
        }

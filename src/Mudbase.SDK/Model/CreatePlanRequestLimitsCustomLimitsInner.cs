...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createPlan_request_limits_customLimits_inner")]
    public partial class CreatePlanRequestLimitsCustomLimitsInner : IValidatableObject
    {
        ...
        public CreatePlanRequestLimitsCustomLimitsInner(string name = default, decimal value = default)
        {
            this.Name = name;
            this.Value = value;
        }

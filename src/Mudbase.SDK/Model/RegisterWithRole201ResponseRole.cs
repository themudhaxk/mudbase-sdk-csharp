...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "registerWithRole_201_response_role")]
    public partial class RegisterWithRole201ResponseRole : IValidatableObject
    {
        ...
        public RegisterWithRole201ResponseRole(string slug = default, string name = default, string description = default)
        {
            this.Slug = slug;
            this.Name = name;

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "configureWebhook_200_response")]
    public partial class ConfigureWebhook200Response : IValidatableObject
    {
        ...
        public ConfigureWebhook200Response(bool success = default, string message = default, ConfigureWebhook200ResponseData data = default)
        {
        ...
        public ConfigureWebhook200ResponseData Data { get; set; }

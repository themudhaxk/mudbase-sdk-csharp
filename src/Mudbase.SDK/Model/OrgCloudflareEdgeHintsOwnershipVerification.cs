...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrgCloudflareEdgeHints_ownershipVerification")]
    public partial class OrgCloudflareEdgeHintsOwnershipVerification : IValidatableObject
    {
        ...
        public OrgCloudflareEdgeHintsOwnershipVerification(string name = default, string type = default, string value = default)
        {
            this.Name = name;
            this.Type = type;
            this.Value = value;

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createRole_201_response_role")]
    public partial class CreateRole201ResponseRole : IValidatableObject
    {
        ...
        public CreateRole201ResponseRole(string id = default, string name = default, string slug = default, string description = default, List<CreateRole201ResponseRolePermissionsInner> permissions = default, decimal hierarchy = default, bool isSystem = default, bool isActive = default)
        {
            this.Id = id;
            this.Name = name;
            this.Slug = slug;
        ...
        public List<CreateRole201ResponseRolePermissionsInner> Permissions { get; set; }

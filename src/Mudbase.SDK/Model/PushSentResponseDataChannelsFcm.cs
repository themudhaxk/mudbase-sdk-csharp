...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PushSentResponse_data_channels_fcm")]
    public partial class PushSentResponseDataChannelsFcm : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PushSentResponseDataChannelsFcm" /> class.
        /// </summary>
        /// <param name="successCount">successCount.</param>
        /// <param name="failureCount">failureCount.</param>
        public PushSentResponseDataChannelsFcm(int successCount = default, int failureCount = default)
        {

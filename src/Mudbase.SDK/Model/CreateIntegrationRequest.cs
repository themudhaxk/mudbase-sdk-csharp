...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createIntegration_request")]
    public partial class CreateIntegrationRequest : IValidatableObject
    {
        ...
        public CreateIntegrationRequest(string name = default, string provider = default, Object config = default, Object credentials = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateIntegrationRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new ArgumentNullException("provider is a required property for CreateIntegrationRequest and cannot be null");
            }
            this.Provider = provider;
            // to ensure "config" is required (not null)
            if (config == null)
            {
                throw new ArgumentNullException("config is a required property for CreateIntegrationRequest and cannot be null");
            }
            this.Config = config;

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "addParticipant_200_response")]
    public partial class AddParticipant200Response : IValidatableObject
    {
        ...
        public AddParticipant200Response(bool success = default, AddParticipant200ResponseData data = default)
        {
        ...
        public AddParticipant200ResponseData Data { get; set; }

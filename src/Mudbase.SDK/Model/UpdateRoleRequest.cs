...
namespace Mudbase.SDK.Model
{
    ...
    /// UpdateRoleRequest
    /// </summary>
    [DataContract(Name = "updateRole_request")]
    public partial class UpdateRoleRequest : IValidatableObject
    {
        ...
        public UpdateRoleRequest(string name = default, string description = default, List<Object> permissions = default, decimal hierarchy = default, bool isActive = default)
        {
            this.Name = name;

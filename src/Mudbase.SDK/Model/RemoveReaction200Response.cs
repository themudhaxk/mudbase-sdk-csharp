...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "removeReaction_200_response")]
    public partial class RemoveReaction200Response : IValidatableObject
    {
        ...
        public RemoveReaction200Response(bool success = default, List<RemoveReaction200ResponseDataInner> data = default)
        {
        ...
        public List<RemoveReaction200ResponseDataInner> Data { get; set; }

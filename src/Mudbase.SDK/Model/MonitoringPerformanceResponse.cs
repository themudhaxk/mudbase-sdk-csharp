...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MonitoringPerformanceResponse")]
    public partial class MonitoringPerformanceResponse : IValidatableObject
    {
        ...
        public MonitoringPerformanceResponse(string period = default, MonitoringPerformanceResponseMetrics metrics = default, List<Object> topEndpoints = default)
        {
            this.Period = period;
        ...
        public MonitoringPerformanceResponseMetrics Metrics { get; set; }

        /// <summary>
        /// Gets or Sets TopEndpoints
        /// </summary>
        [DataMember(Name = "topEndpoints", EmitDefaultValue = false)]
        public List<Object> TopEndpoints { get; set; }

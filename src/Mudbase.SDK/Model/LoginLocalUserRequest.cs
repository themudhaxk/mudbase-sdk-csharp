...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "loginLocalUser_request")]
    public partial class LoginLocalUserRequest : IValidatableObject
    {
        ...
        protected LoginLocalUserRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LoginLocalUserRequest" /> class.
        /// </summary>
        ...
        public LoginLocalUserRequest(string email = default, string password = default, string projectId = default)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for LoginLocalUserRequest and cannot be null");
            }
            this.Email = email;
            // to ensure "password" is required (not null)
            if (password == null)
            {
                throw new ArgumentNullException("password is a required property for LoginLocalUserRequest and cannot be null");
            }

...
namespace Mudbase.SDK.Model
{
    ...
    /// AddReactionRequest
    /// </summary>
    [DataContract(Name = "addReaction_request")]
    public partial class AddReactionRequest : IValidatableObject
    {
        ...
        protected AddReactionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddReactionRequest" /> class.
        /// </summary>
        /// <param name="emoji">emoji (required).</param>
        public AddReactionRequest(string emoji = default)
        {
            // to ensure "emoji" is required (not null)
            if (emoji == null)
            {
                throw new ArgumentNullException("emoji is a required property for AddReactionRequest and cannot be null");
            }
            this.Emoji = emoji;
        }

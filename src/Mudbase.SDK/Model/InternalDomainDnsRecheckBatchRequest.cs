...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "internalDomainDnsRecheckBatch_request")]
    public partial class InternalDomainDnsRecheckBatchRequest : IValidatableObject
    {
        ...
        public InternalDomainDnsRecheckBatchRequest(int maxOrgs = default, int recheckOlderThanHours = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "maxOrgs", EmitDefaultValue = false)]
        public int MaxOrgs { get; set; }

        /// <summary>
        /// Gets or Sets RecheckOlderThanHours
        /// </summary>
        [DataMember(Name = "recheckOlderThanHours", EmitDefaultValue = false)]
        public int RecheckOlderThanHours { get; set; }

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "verifiedRoleUpgrade_200_response")]
    public partial class VerifiedRoleUpgrade200Response : IValidatableObject
    {
        ...
        public VerifiedRoleUpgrade200Response(string message = default, string role = default, string previousRole = default, string upgradeLog = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "previousRole", EmitDefaultValue = false)]
        public string PreviousRole { get; set; }

        /// <summary>
        /// Gets or Sets UpgradeLog
        /// </summary>
        [DataMember(Name = "upgradeLog", EmitDefaultValue = false)]

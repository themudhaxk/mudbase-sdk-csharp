...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "configureWebhook_200_response_data")]
    public partial class ConfigureWebhook200ResponseData : IValidatableObject
    {
        ...
        public ConfigureWebhook200ResponseData(string webhookUrl = default, List<string> webhookEvents = default, string webhookVersion = default, List<ConfigureWebhook200ResponseDataTransformationsInner> transformations = default)
        {
        ...
        public List<ConfigureWebhook200ResponseDataTransformationsInner> Transformations { get; set; }

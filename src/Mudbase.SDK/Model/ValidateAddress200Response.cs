...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "validateAddress_200_response")]
    public partial class ValidateAddress200Response : IValidatableObject
    {
        ...
        public ValidateAddress200Response(bool success = default, ValidateAddress200ResponseData data = default)
        {
        ...
        public ValidateAddress200ResponseData Data { get; set; }

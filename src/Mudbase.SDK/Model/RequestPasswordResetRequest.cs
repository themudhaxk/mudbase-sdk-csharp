...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "requestPasswordReset_request")]
    public partial class RequestPasswordResetRequest : IValidatableObject
    {
        ...
        protected RequestPasswordResetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestPasswordResetRequest" /> class.
        /// </summary>
        /// <param name="email">email (required).</param>
        public RequestPasswordResetRequest(string email = default)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for RequestPasswordResetRequest and cannot be null");
            }
            this.Email = email;
        }

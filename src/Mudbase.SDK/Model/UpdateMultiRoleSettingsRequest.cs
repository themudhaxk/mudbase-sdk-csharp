...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateMultiRoleSettings_request")]
    public partial class UpdateMultiRoleSettingsRequest : IValidatableObject
    {
        ...
        public UpdateMultiRoleSettingsRequest(bool isEnabled = default, string defaultRole = default, UpdateMultiRoleSettingsRequestSettings settings = default)
        {
        ...
        */
        ...
        public UpdateMultiRoleSettingsRequestSettings Settings { get; set; }

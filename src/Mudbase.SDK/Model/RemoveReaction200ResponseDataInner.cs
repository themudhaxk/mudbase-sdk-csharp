...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "removeReaction_200_response_data_inner")]
    public partial class RemoveReaction200ResponseDataInner : IValidatableObject
    {
        ...
        public RemoveReaction200ResponseDataInner(string emoji = default, int count = default, List<string> users = default)
        {
            this.Emoji = emoji;
            this.Count = count;
            this.Users = users;

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "generatePrivateKey_200_response")]
    public partial class GeneratePrivateKey200Response : IValidatableObject
    {
        ...
        public GeneratePrivateKey200Response(bool success = default, GeneratePrivateKey200ResponseData data = default)
        {
        ...
        public GeneratePrivateKey200ResponseData Data { get; set; }

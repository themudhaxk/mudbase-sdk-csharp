...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "checkUserPresence_200_response")]
    public partial class CheckUserPresence200Response : IValidatableObject
    {
        ...
        public CheckUserPresence200Response(Dictionary<string, CheckUserPresence200ResponsePresenceValue> presence = default, DateTime timestamp = default)
        {
        ...
        public Dictionary<string, CheckUserPresence200ResponsePresenceValue> Presence { get; set; }

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getChatDetails_200_response_data")]
    public partial class GetChatDetails200ResponseData : IValidatableObject
    {
        ...
        public GetChatDetails200ResponseData(string id = default, string name = default, List<GetChatDetails200ResponseDataParticipantsInner> participants = default)
        {
            this.Id = id;
            this.Name = name;
        ...
        public List<GetChatDetails200ResponseDataParticipantsInner> Participants { get; set; }

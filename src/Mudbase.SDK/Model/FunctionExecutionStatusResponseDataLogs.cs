...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FunctionExecutionStatusResponse_data_logs")]
    public partial class FunctionExecutionStatusResponseDataLogs : IValidatableObject
    {
        ...
        public FunctionExecutionStatusResponseDataLogs(string stdout = default, string stderr = default, bool truncated = default, int bytes = default)
        {
            this.Stdout = stdout;
            this.Stderr = stderr;

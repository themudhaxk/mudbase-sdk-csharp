...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemStatusResponse")]
    public partial class SystemStatusResponse : IValidatableObject
    {
        ...
        public SystemStatusResponse(bool success = default, SystemStatusResponseData data = default)
        {
        ...
        public SystemStatusResponseData Data { get; set; }

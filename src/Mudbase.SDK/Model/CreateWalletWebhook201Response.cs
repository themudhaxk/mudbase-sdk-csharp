...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createWalletWebhook_201_response")]
    public partial class CreateWalletWebhook201Response : IValidatableObject
    {
        ...
        public CreateWalletWebhook201Response(bool success = default, string message = default, WalletWebhook data = default)
        {
        ...
        public WalletWebhook Data { get; set; }

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PushSentResponse_data_channels_webPush")]
    public partial class PushSentResponseDataChannelsWebPush : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PushSentResponseDataChannelsWebPush" /> class.
        /// </summary>
        /// <param name="successCount">successCount.</param>
        /// <param name="failureCount">failureCount.</param>
        /// <param name="pruned">Subscriptions the push service reported as gone (404/410) and that were pruned during this send. .</param>
        public PushSentResponseDataChannelsWebPush(int successCount = default, int failureCount = default, int pruned = default)
        {
        ...
        /// </summary>
        /// <value>Subscriptions the push service reported as gone (404/410) and that were pruned during this send. </value>
        [DataMember(Name = "pruned", EmitDefaultValue = false)]

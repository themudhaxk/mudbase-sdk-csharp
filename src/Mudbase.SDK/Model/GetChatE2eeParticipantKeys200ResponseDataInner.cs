...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getChatE2eeParticipantKeys_200_response_data_inner")]
    public partial class GetChatE2eeParticipantKeys200ResponseDataInner : IValidatableObject
    {
        ...
        public GetChatE2eeParticipantKeys200ResponseDataInner(string userId = default, string identityPublicKey = default, int keyVersion = default, DateTime updatedAt = default)
        {
            this.UserId = userId;
        ...
        /// </summary>
        [DataMember(Name = "identityPublicKey", EmitDefaultValue = false)]

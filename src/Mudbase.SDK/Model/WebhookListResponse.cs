...
namespace Mudbase.SDK.Model
{
    ...
    public partial class WebhookListResponse : IValidatableObject
    {
        ...
        public WebhookListResponse(List<WebhookLog> webhooks = default, int total = default, int page = default, int limit = default, int totalPages = default)
        {
        ...
        public List<WebhookLog> Webhooks { get; set; }

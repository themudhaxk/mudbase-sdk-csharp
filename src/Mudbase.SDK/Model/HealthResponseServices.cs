...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HealthResponse_services")]
    public partial class HealthResponseServices : IValidatableObject
    {
        ...
        public HealthResponseServices(string database = default, string redis = default, string storage = default, string email = default, string sms = default)
        {

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createAnonymousSession_200_response_user")]
    public partial class CreateAnonymousSession200ResponseUser : IValidatableObject
    {
        ...
        public CreateAnonymousSession200ResponseUser(string id = default, string email = default, string firstName = default, string lastName = default, string role = default, bool isAnonymous = default)
        {
            this.Id = id;
            this.Email = email;

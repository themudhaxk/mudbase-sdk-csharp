...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "resetLocalPassword_request")]
    public partial class ResetLocalPasswordRequest : IValidatableObject
    {
        ...
        protected ResetLocalPasswordRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResetLocalPasswordRequest" /> class.
        /// </summary>
        /// <param name="password">password (required).</param>
        /// <param name="projectId">projectId.</param>
        public ResetLocalPasswordRequest(string password = default, string projectId = default)
        {
            // to ensure "password" is required (not null)
            if (password == null)
            {
                throw new ArgumentNullException("password is a required property for ResetLocalPasswordRequest and cannot be null");
            }

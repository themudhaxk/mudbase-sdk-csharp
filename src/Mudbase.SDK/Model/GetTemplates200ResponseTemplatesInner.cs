...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getTemplates_200_response_templates_inner")]
    public partial class GetTemplates200ResponseTemplatesInner : IValidatableObject
    {
        ...
        public GetTemplates200ResponseTemplatesInner(string id = default, string name = default, string provider = default, string description = default)
        {
            this.Id = id;
            this.Name = name;

...
namespace Mudbase.SDK.Model
{
    ...
    /// Withdraw200Response
    /// </summary>
    [DataContract(Name = "withdraw_200_response")]
    public partial class Withdraw200Response : IValidatableObject
    {
        ...
        public Withdraw200Response(bool success = default, string message = default, Withdraw200ResponseData data = default)
        {
        ...
        public Withdraw200ResponseData Data { get; set; }

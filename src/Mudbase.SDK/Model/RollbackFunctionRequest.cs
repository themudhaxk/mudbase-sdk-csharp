...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "rollbackFunction_request")]
    public partial class RollbackFunctionRequest : IValidatableObject
    {
        ...
        protected RollbackFunctionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RollbackFunctionRequest" /> class.
        /// </summary>
        /// <param name="varVersion">Version number to rollback to (required).</param>
        public RollbackFunctionRequest(int varVersion = default)
        {

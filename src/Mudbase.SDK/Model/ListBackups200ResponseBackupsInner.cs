...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listBackups_200_response_backups_inner")]
    public partial class ListBackups200ResponseBackupsInner : IValidatableObject
    {
        ...
        public ListBackups200ResponseBackupsInner(string id = default, string description = default, string status = default, int size = default, List<string> collections = default, int fileCount = default, DateTime createdAt = default, DateTime completedAt = default)
        {
            this.Id = id;

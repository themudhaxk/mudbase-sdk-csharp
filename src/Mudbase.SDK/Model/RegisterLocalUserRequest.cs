...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "registerLocalUser_request")]
    public partial class RegisterLocalUserRequest : IValidatableObject
    {
        ...
        protected RegisterLocalUserRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RegisterLocalUserRequest" /> class.
        /// </summary>
        ...
        public RegisterLocalUserRequest(string email = default, string password = default, string firstName = default, string lastName = default, string projectId = default)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for RegisterLocalUserRequest and cannot be null");
            }
            this.Email = email;
            // to ensure "password" is required (not null)
            if (password == null)
            {
                throw new ArgumentNullException("password is a required property for RegisterLocalUserRequest and cannot be null");
            }
            this.Password = password;
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for RegisterLocalUserRequest and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for RegisterLocalUserRequest and cannot be null");
            }
            this.LastName = lastName;
            // to ensure "projectId" is required (not null)
            if (projectId == null)
            {
                throw new ArgumentNullException("projectId is a required property for RegisterLocalUserRequest and cannot be null");
            }

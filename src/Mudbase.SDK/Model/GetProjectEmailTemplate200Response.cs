...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getProjectEmailTemplate_200_response")]
    public partial class GetProjectEmailTemplate200Response : IValidatableObject
    {
        ...
        public GetProjectEmailTemplate200Response(bool success = default, EmailTemplateResolved data = default)
        {
        ...
        public EmailTemplateResolved Data { get; set; }

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getActiveUsers_200_response")]
    public partial class GetActiveUsers200Response : IValidatableObject
    {
        ...
        public GetActiveUsers200Response(List<GetActiveUsers200ResponseUsersInner> users = default, int count = default, DateTime timestamp = default)
        {
            this.Users = users;
            this.Count = count;
        ...
        public List<GetActiveUsers200ResponseUsersInner> Users { get; set; }

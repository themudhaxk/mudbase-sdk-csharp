...
namespace Mudbase.SDK.Model
{
    ...
    /// Disable2FARequest
    /// </summary>
    [DataContract(Name = "disable2FA_request")]
    public partial class Disable2FARequest : IValidatableObject
    {
        ...
        protected Disable2FARequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Disable2FARequest" /> class.
        /// </summary>
        /// <param name="password">password (required).</param>
        /// <param name="token">token (required).</param>
        public Disable2FARequest(string password = default, string token = default)
        {
            // to ensure "password" is required (not null)
            if (password == null)
            {
                throw new ArgumentNullException("password is a required property for Disable2FARequest and cannot be null");
            }
            this.Password = password;
            // to ensure "token" is required (not null)
            if (token == null)
            {
                throw new ArgumentNullException("token is a required property for Disable2FARequest and cannot be null");
            }
            this.Token = token;
        }

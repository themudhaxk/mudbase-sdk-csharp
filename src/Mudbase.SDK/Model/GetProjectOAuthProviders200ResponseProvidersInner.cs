...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getProjectOAuthProviders_200_response_providers_inner")]
    public partial class GetProjectOAuthProviders200ResponseProvidersInner : IValidatableObject
    {
        ...
        public GetProjectOAuthProviders200ResponseProvidersInner(string name = default, string displayName = default, string authUrl = default)
        {
            this.Name = name;
        ...
        */
        ...
        /// </summary>
        /*
        <example>/api/auth/oauth/google?projectId&#x3D;65f1a2b3c4d5e6f7a8b9c0d1</example>
        */

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MonitoringAnalyticsResponse")]
    public partial class MonitoringAnalyticsResponse : IValidatableObject
    {
        ...
        public MonitoringAnalyticsResponse(string period = default, string granularity = default, int days = default, List<MonitoringAnalyticsResponseStatsInner> stats = default, MonitoringAnalyticsResponseTotals totals = default)
        {
            this.Period = period;
        ...
        public List<MonitoringAnalyticsResponseStatsInner> Stats { get; set; }

        /// <summary>
        /// Gets or Sets Totals
        /// </summary>
        [DataMember(Name = "totals", EmitDefaultValue = false)]
        public MonitoringAnalyticsResponseTotals Totals { get; set; }

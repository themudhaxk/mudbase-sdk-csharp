...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "initializePayment_200_response")]
    public partial class InitializePayment200Response : IValidatableObject
    {
        ...
        public InitializePayment200Response(bool success = default, InitializePayment200ResponseData data = default)
        {
        ...
        public InitializePayment200ResponseData Data { get; set; }

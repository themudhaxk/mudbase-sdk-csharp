...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getNonCustodialTransactionByHash_200_response")]
    public partial class GetNonCustodialTransactionByHash200Response : IValidatableObject
    {
        ...
        public GetNonCustodialTransactionByHash200Response(bool success = default, WalletTransaction data = default)
        {
        ...
        public WalletTransaction Data { get; set; }

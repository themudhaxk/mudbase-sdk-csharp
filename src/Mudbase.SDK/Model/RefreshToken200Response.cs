...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "refreshToken_200_response")]
    public partial class RefreshToken200Response : IValidatableObject
    {
        ...
        public RefreshToken200Response(string message = default, string token = default, string refreshToken = default, int expiresIn = default)
        {

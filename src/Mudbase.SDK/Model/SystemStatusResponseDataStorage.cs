...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemStatusResponse_data_storage")]
    public partial class SystemStatusResponseDataStorage : IValidatableObject
    {
        ...
        public SystemStatusResponseDataStorage(int used = default, int available = default, decimal percentage = default)
        {
            this.Used = used;

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "checkSubscription_200_response")]
    public partial class CheckSubscription200Response : IValidatableObject
    {
        ...
        public CheckSubscription200Response(bool hasSubscription = default, CheckSubscription200ResponseSubscription subscription = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "hasSubscription", EmitDefaultValue = true)]
        ...
        public CheckSubscription200ResponseSubscription Subscription { get; set; }

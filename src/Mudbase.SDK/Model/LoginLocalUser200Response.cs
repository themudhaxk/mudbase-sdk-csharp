...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "loginLocalUser_200_response")]
    public partial class LoginLocalUser200Response : IValidatableObject
    {
        ...
        public LoginLocalUser200Response(string message = default, string token = default, string refreshToken = default, int expiresIn = default, LoginLocalUser200ResponseUser user = default)
        {
        ...
        public LoginLocalUser200ResponseUser User { get; set; }

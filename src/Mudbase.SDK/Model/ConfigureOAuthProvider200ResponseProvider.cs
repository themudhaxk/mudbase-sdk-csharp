...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "configureOAuthProvider_200_response_provider")]
    public partial class ConfigureOAuthProvider200ResponseProvider : IValidatableObject
    {
        ...
        public ConfigureOAuthProvider200ResponseProvider(string name = default, bool enabled = default, string displayName = default)
        {
            this.Name = name;

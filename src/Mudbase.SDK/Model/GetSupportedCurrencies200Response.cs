...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getSupportedCurrencies_200_response")]
    public partial class GetSupportedCurrencies200Response : IValidatableObject
    {
        ...
        public GetSupportedCurrencies200Response(bool success = default, GetSupportedCurrencies200ResponseData data = default)
        {
        ...
        public GetSupportedCurrencies200ResponseData Data { get; set; }

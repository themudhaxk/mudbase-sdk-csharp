...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getUsageStats_200_response")]
    public partial class GetUsageStats200Response : IValidatableObject
    {
        ...
        public GetUsageStats200Response(GetUsageStats200ResponseStats stats = default)
        {
            this.Stats = stats;
        }
        ...
        public GetUsageStats200ResponseStats Stats { get; set; }

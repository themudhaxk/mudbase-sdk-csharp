...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "addParticipant_200_response_data_participants_inner")]
    public partial class AddParticipant200ResponseDataParticipantsInner : IValidatableObject
    {
        ...
        public AddParticipant200ResponseDataParticipantsInner(string userId = default, string role = default, DateTime addedAt = default)
        {
            this.UserId = userId;
            this.Role = role;

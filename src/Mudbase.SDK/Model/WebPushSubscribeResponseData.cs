...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebPushSubscribeResponse_data")]
    public partial class WebPushSubscribeResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebPushSubscribeResponseData" /> class.
        /// </summary>
        /// <param name="endpoint">endpoint.</param>
        /// <param name="userId">userId.</param>
        /// <param name="lastSeenAt">lastSeenAt.</param>
        public WebPushSubscribeResponseData(string endpoint = default, string userId = default, DateTime lastSeenAt = default)
        {

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getFunctionVersions_200_response_data_versions_inner")]
    public partial class GetFunctionVersions200ResponseDataVersionsInner : IValidatableObject
    {
        ...
        public GetFunctionVersions200ResponseDataVersionsInner(string id = default, string code = default, int varVersion = default, DateTime createdAt = default, string createdBy = default, string comment = default)
        {
            this.Id = id;
            this.Code = code;

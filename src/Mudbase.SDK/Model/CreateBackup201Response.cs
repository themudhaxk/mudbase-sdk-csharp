...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createBackup_201_response")]
    public partial class CreateBackup201Response : IValidatableObject
    {
        ...
        public CreateBackup201Response(CreateBackup201ResponseBackup backup = default)
        {
            this.Backup = backup;
        }
        ...
        public CreateBackup201ResponseBackup Backup { get; set; }

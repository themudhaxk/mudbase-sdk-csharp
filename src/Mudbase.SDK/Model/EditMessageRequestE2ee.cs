...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "editMessage_request_e2ee")]
    public partial class EditMessageRequestE2ee : IValidatableObject
    {
        ...
        public EditMessageRequestE2ee(int varVersion = default, string scheme = default, string ciphertext = default, string nonce = default, string ephemeralPublicKey = default, string senderKeyId = default)
        {

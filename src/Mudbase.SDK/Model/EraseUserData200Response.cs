...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "eraseUserData_200_response")]
    public partial class EraseUserData200Response : IValidatableObject
    {
        ...
        public EraseUserData200Response(bool success = default, string message = default, EraseUserData200ResponseData data = default)
        {
        ...
        */
        ...
        public EraseUserData200ResponseData Data { get; set; }

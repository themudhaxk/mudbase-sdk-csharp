...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getPaymentRecords_200_response_data_records_inner")]
    public partial class GetPaymentRecords200ResponseDataRecordsInner : IValidatableObject
    {
        ...
        public GetPaymentRecords200ResponseDataRecordsInner(string txRef = default, decimal amount = default, decimal orgReceives = default, string status = default, string paidAt = default)
        {
            this.TxRef = txRef;
            this.Amount = amount;

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getDashboard_200_response")]
    public partial class GetDashboard200Response : IValidatableObject
    {
        ...
        public GetDashboard200Response(decimal revenue = default, int subscriptions = default, int activePlans = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "activePlans", EmitDefaultValue = false)]

...
namespace Mudbase.SDK.Model
{
    ...
    public partial class CreateBackupRequest : IValidatableObject
    {
        ...
        public CreateBackupRequest(string description = default, bool includeFiles = true, bool includeWallets = false)
        {
        ...
        */
        [DataMember(Name = "includeFiles", EmitDefaultValue = true)]
        ...
        */
        [DataMember(Name = "includeWallets", EmitDefaultValue = true)]

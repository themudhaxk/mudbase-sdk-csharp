...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getSubOrganizations_200_response")]
    public partial class GetSubOrganizations200Response : IValidatableObject
    {
        ...
        public GetSubOrganizations200Response(List<Organization> suborgs = default, int total = default)
        {
        ...
        public List<Organization> Suborgs { get; set; }

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getProjectUsers_200_response")]
    public partial class GetProjectUsers200Response : IValidatableObject
    {
        ...
        public GetProjectUsers200Response(List<GetOrganizationUsers200ResponseUsersInner> users = default, int total = default, GetOrganizationUsers200ResponseUsersInnerProject project = default)
        {
            this.Users = users;
            this.Total = total;
        ...
        public List<GetOrganizationUsers200ResponseUsersInner> Users { get; set; }

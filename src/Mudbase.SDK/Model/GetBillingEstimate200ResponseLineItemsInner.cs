...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getBillingEstimate_200_response_lineItems_inner")]
    public partial class GetBillingEstimate200ResponseLineItemsInner : IValidatableObject
    {
        ...
        public GetBillingEstimate200ResponseLineItemsInner(string resource = default, decimal units = default, decimal amount = default, string currency = default, string unit = default)
        {

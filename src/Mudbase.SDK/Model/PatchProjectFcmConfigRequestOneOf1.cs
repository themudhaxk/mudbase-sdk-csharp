...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "patchProjectFcmConfig_request_oneOf_1")]
    public partial class PatchProjectFcmConfigRequestOneOf1 : IValidatableObject
    {
        ...
        protected PatchProjectFcmConfigRequestOneOf1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchProjectFcmConfigRequestOneOf1" /> class.
        /// </summary>
        /// <param name="clear">clear (required).</param>
        public PatchProjectFcmConfigRequestOneOf1(bool clear = default)
        {
            this.Clear = clear;
        }
        ...
        /// Gets or Sets Clear
        /// </summary>
        [DataMember(Name = "clear", IsRequired = true, EmitDefaultValue = true)]

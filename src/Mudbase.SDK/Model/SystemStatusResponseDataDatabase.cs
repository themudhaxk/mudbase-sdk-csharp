...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemStatusResponse_data_database")]
    public partial class SystemStatusResponseDataDatabase : IValidatableObject
    {
        ...
        public SystemStatusResponseDataDatabase(int connections = default, int maxConnections = default, int responseTime = default)
        {

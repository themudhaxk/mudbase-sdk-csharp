...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "handleFlutterwaveWebhook_request")]
    public partial class HandleFlutterwaveWebhookRequest : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="varEvent">Event type (e.g. charge.completed, payment.successful).</param>
        /// <param name="data">data.</param>
        public HandleFlutterwaveWebhookRequest(string varEvent = default, HandleFlutterwaveWebhookRequestData data = default)
        {
            this.Event = varEvent;
            this.Data = data;
        }
        ...
        public HandleFlutterwaveWebhookRequestData Data { get; set; }

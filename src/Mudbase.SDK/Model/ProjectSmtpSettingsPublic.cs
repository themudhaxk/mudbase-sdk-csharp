...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectSmtpSettingsPublic")]
    public partial class ProjectSmtpSettingsPublic : IValidatableObject
    {
        ...
        public ProjectSmtpSettingsPublic(bool enabled = default, string host = default, int port = default, bool secure = default, string authUser = default, bool hasPassword = default, string fromName = default, string fromEmail = default, DateTime? domainVerifiedAt = default)
        {

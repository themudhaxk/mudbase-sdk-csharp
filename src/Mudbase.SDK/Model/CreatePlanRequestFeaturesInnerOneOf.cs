...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createPlan_request_features_inner_oneOf")]
    public partial class CreatePlanRequestFeaturesInnerOneOf : IValidatableObject
    {
        ...
        public CreatePlanRequestFeaturesInnerOneOf(string name = default, string description = default, bool included = true, decimal? limit = default)
        {
            this.Name = name;

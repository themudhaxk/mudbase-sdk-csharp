...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookStatsResponse_statusStats_inner")]
    public partial class WebhookStatsResponseStatusStatsInner : IValidatableObject
    {
        ...
        public WebhookStatsResponseStatusStatsInner(string id = default, int count = default, decimal? avgDuration = default)
        {
            this.Id = id;
            this.Count = count;
        ...
        [DataMember(Name = "avgDuration", EmitDefaultValue = true)]

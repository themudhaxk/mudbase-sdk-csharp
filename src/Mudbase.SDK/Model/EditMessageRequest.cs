...
namespace Mudbase.SDK.Model
{
    ...
    /// EditMessageRequest
    /// </summary>
    [DataContract(Name = "editMessage_request")]
    public partial class EditMessageRequest : IValidatableObject
    {
        ...
        public EditMessageRequest(string content = default, EditMessageRequestE2ee e2ee = default)
        {
        ...
        public EditMessageRequestE2ee E2ee { get; set; }

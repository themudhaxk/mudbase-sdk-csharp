...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebPushUnsubscribeResponse_data")]
    public partial class WebPushUnsubscribeResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebPushUnsubscribeResponseData" /> class.
        /// </summary>
        /// <param name="removed">True if a matching subscription was removed; false if none was registered. .</param>
        public WebPushUnsubscribeResponseData(bool removed = default)
        {
        ...
        /// </summary>
        /// <value>True if a matching subscription was removed; false if none was registered. </value>

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MessageHistoryResponse")]
    public partial class MessageHistoryResponse : IValidatableObject
    {
        ...
        public MessageHistoryResponse(bool success = default, MessageHistoryResponseData data = default)
        {
        ...
        public MessageHistoryResponseData Data { get; set; }

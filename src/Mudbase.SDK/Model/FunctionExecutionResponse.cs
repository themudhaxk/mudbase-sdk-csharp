...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FunctionExecutionResponse")]
    public partial class FunctionExecutionResponse : IValidatableObject
    {
        ...
        public FunctionExecutionResponse(bool success = default, FunctionExecutionResponseData data = default)
        {
        ...
        public FunctionExecutionResponseData Data { get; set; }

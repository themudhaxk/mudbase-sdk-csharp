...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "requestLocalPasswordReset_request")]
    public partial class RequestLocalPasswordResetRequest : IValidatableObject
    {
        ...
        protected RequestLocalPasswordResetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestLocalPasswordResetRequest" /> class.
        /// </summary>
        /// <param name="email">email (required).</param>
        /// <param name="projectId">Required for project-based reset (sends OTP). Omit for org token link..</param>
        public RequestLocalPasswordResetRequest(string email = default, string projectId = default)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for RequestLocalPasswordResetRequest and cannot be null");
            }
            this.Email = email;

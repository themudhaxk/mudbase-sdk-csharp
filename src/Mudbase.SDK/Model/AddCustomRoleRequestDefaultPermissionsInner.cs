...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "addCustomRole_request_defaultPermissions_inner")]
    public partial class AddCustomRoleRequestDefaultPermissionsInner : IValidatableObject
    {
        ...
        public AddCustomRoleRequestDefaultPermissionsInner(string resource = default, List<string> actions = default)
        {

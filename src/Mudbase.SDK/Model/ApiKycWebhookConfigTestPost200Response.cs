...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_kyc_webhook_config_test_post_200_response")]
    public partial class ApiKycWebhookConfigTestPost200Response : IValidatableObject
    {
        ...
        public ApiKycWebhookConfigTestPost200Response(bool ok = default, int? httpStatus = default, string error = default)
        {
            this.Ok = ok;

...
namespace Mudbase.SDK.Model
{
    ...
    /// RecordUsageRequest
    /// </summary>
    [DataContract(Name = "recordUsage_request")]
    public partial class RecordUsageRequest : IValidatableObject
    {
        ...
        protected RecordUsageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RecordUsageRequest" /> class.
        /// </summary>
        /// <param name="email">Customer email (required).</param>
        /// <param name="metric">Usage metric name (e.g. api_calls, storage_mb) (required).</param>
        /// <param name="quantity">Quantity to record (required).</param>
        public RecordUsageRequest(string email = default, string metric = default, decimal quantity = default)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for RecordUsageRequest and cannot be null");
            }
            this.Email = email;
            // to ensure "metric" is required (not null)
            if (metric == null)
            {
                throw new ArgumentNullException("metric is a required property for RecordUsageRequest and cannot be null");
            }
            this.Metric = metric;

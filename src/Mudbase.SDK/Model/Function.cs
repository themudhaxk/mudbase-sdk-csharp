...
namespace Mudbase.SDK.Model
{
    ...
    public partial class Function : IValidatableObject
    {
        ...
        public Function(string id = default, string name = default, string description = default, string projectId = default, FunctionTrigger trigger = default, FunctionStats stats = default, bool isActive = default, string createdBy = default, DateTime createdAt = default, DateTime updatedAt = default)
        {
            this.Id = id;
            this.Name = name;

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getPermissionsMatrix_200_response")]
    public partial class GetPermissionsMatrix200Response : IValidatableObject
    {
        ...
        public GetPermissionsMatrix200Response(bool success = default, GetPermissionsMatrix200ResponseData data = default)
        {
        ...
        public GetPermissionsMatrix200ResponseData Data { get; set; }

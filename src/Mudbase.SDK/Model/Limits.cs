...
namespace Mudbase.SDK.Model
{
    ...
    public partial class Limits : IValidatableObject
    {
        ...
        public Limits(int projects = default, int users = default, int storage = default, int bandwidth = default, int apiCalls = default, int dbReads = default, int dbWrites = default)
        {

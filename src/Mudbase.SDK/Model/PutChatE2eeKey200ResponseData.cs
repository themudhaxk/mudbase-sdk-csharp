...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "putChatE2eeKey_200_response_data")]
    public partial class PutChatE2eeKey200ResponseData : IValidatableObject
    {
        ...
        public PutChatE2eeKey200ResponseData(string identityPublicKey = default, int keyVersion = default, DateTime updatedAt = default)
        {

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "requestManualPayout_request")]
    public partial class RequestManualPayoutRequest : IValidatableObject
    {
        ...
        protected RequestManualPayoutRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestManualPayoutRequest" /> class.
        /// </summary>
        /// <param name="currency">currency (required).</param>
        public RequestManualPayoutRequest(string currency = default)
        {
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for RequestManualPayoutRequest and cannot be null");
            }

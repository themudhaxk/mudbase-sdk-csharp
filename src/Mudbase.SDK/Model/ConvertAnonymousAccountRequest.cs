...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "convertAnonymousAccount_request")]
    public partial class ConvertAnonymousAccountRequest : IValidatableObject
    {
        ...
        protected ConvertAnonymousAccountRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConvertAnonymousAccountRequest" /> class.
        /// </summary>
        ...
        public ConvertAnonymousAccountRequest(string email = default, string password = default, string firstName = default, string lastName = default)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for ConvertAnonymousAccountRequest and cannot be null");
            }
            this.Email = email;
            // to ensure "password" is required (not null)
            if (password == null)
            {
                throw new ArgumentNullException("password is a required property for ConvertAnonymousAccountRequest and cannot be null");
            }

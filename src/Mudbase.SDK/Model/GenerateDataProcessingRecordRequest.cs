...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "generateDataProcessingRecord_request")]
    public partial class GenerateDataProcessingRecordRequest : IValidatableObject
    {
        ...
        protected GenerateDataProcessingRecordRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateDataProcessingRecordRequest" /> class.
        /// </summary>
        /// <param name="orgId">orgId (required).</param>
        /// <param name="recordDate">recordDate.</param>
        public GenerateDataProcessingRecordRequest(string orgId = default, DateTime recordDate = default)
        {
            // to ensure "orgId" is required (not null)
            if (orgId == null)
            {
                throw new ArgumentNullException("orgId is a required property for GenerateDataProcessingRecordRequest and cannot be null");
            }
            this.OrgId = orgId;

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "validateAddress_request")]
    public partial class ValidateAddressRequest : IValidatableObject
    {
        ...
        public ValidateAddressRequest(CurrencyEnum currency = default, string address = default)
        {
            this.Currency = currency;
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for ValidateAddressRequest and cannot be null");
            }

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getOrganizationUsers_200_response_users_inner_project")]
    public partial class GetOrganizationUsers200ResponseUsersInnerProject : IValidatableObject
    {
        ...
        public GetOrganizationUsers200ResponseUsersInnerProject(string id = default, string name = default, string slug = default)
        {
            this.Id = id;
            this.Name = name;
            this.Slug = slug;

...
namespace Mudbase.SDK.Model
{
    ...
    /// DataListResponse
    /// </summary>
    [DataContract(Name = "DataListResponse")]
    public partial class DataListResponse : IValidatableObject
    {
        ...
        public DataListResponse(List<DataListResponseDataInner> data = default, Pagination pagination = default)
        {
            this.Data = data;
        ...
        public List<DataListResponseDataInner> Data { get; set; }

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getOrganizationUsers_200_response")]
    public partial class GetOrganizationUsers200Response : IValidatableObject
    {
        ...
        public GetOrganizationUsers200Response(List<GetOrganizationUsers200ResponseUsersInner> users = default, int total = default)
        {
            this.Users = users;
            this.Total = total;
        }

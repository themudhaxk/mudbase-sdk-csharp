...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "generatePrivateKey_200_response_data")]
    public partial class GeneratePrivateKey200ResponseData : IValidatableObject
    {
        ...
        public GeneratePrivateKey200ResponseData(string currency = default, string privateKey = default, string publicKey = default, string warning = default)
        {

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getSpeedUpParams_request")]
    public partial class GetSpeedUpParamsRequest : IValidatableObject
    {
        ...
        protected GetSpeedUpParamsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSpeedUpParamsRequest" /> class.
        /// </summary>
        ...
        /// <param name="chain">EVM chain (speed-up is EVM only) (required).</param>
        public GetSpeedUpParamsRequest(string txId = default, string txHash = default, ChainEnum chain = default)
        {
            this.Chain = chain;
            this.TxId = txId;
            this.TxHash = txHash;

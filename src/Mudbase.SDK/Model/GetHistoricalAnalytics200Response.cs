...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getHistoricalAnalytics_200_response")]
    public partial class GetHistoricalAnalytics200Response : IValidatableObject
    {
        ...
        public GetHistoricalAnalytics200Response(string projectId = default, string period = default, List<GetHistoricalAnalytics200ResponseDataInner> data = default, DateTime generatedAt = default)
        {
        ...
        public List<GetHistoricalAnalytics200ResponseDataInner> Data { get; set; }

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createBackup_201_response_backup")]
    public partial class CreateBackup201ResponseBackup : IValidatableObject
    {
        ...
        public CreateBackup201ResponseBackup(string id = default, string project = default, string description = default, StatusEnum? status = default, int size = default, List<string> collections = default, DateTime createdAt = default, DateTime estimatedCompletion = default)
        {
            this.Id = id;

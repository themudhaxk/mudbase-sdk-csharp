...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "importIntegration_request")]
    public partial class ImportIntegrationRequest : IValidatableObject
    {
        ...
        protected ImportIntegrationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportIntegrationRequest" /> class.
        /// </summary>
        /// <param name="integrationData">integrationData (required).</param>
        public ImportIntegrationRequest(Object integrationData = default)
        {
            // to ensure "integrationData" is required (not null)
            if (integrationData == null)
            {
                throw new ArgumentNullException("integrationData is a required property for ImportIntegrationRequest and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "integrationData", IsRequired = true, EmitDefaultValue = true)]

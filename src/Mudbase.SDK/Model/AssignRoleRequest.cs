...
namespace Mudbase.SDK.Model
{
    ...
    /// AssignRoleRequest
    /// </summary>
    [DataContract(Name = "assignRole_request")]
    public partial class AssignRoleRequest : IValidatableObject
    {
        ...
        protected AssignRoleRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignRoleRequest" /> class.
        /// </summary>
        /// <param name="roleSlug">roleSlug (required).</param>
        public AssignRoleRequest(string roleSlug = default)
        {
            // to ensure "roleSlug" is required (not null)
            if (roleSlug == null)
            {
                throw new ArgumentNullException("roleSlug is a required property for AssignRoleRequest and cannot be null");
            }

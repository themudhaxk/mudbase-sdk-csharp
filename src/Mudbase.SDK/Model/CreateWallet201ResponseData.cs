...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createWallet_201_response_data")]
    public partial class CreateWallet201ResponseData : IValidatableObject
    {
        ...
        public CreateWallet201ResponseData(string id = default, string currency = default, string address = default, string balance = default, bool isCustomKey = default, string project = default, DateTime createdAt = default)
        {
            this.Id = id;
        ...
        /// </summary>
        [DataMember(Name = "isCustomKey", EmitDefaultValue = true)]

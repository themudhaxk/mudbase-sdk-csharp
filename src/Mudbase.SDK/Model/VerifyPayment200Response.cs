...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "verifyPayment_200_response")]
    public partial class VerifyPayment200Response : IValidatableObject
    {
        ...
        public VerifyPayment200Response(bool success = default, string message = default, VerifyPayment200ResponseData data = default)
        {
        ...
        public VerifyPayment200ResponseData Data { get; set; }

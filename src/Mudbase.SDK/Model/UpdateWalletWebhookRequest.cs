...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateWalletWebhook_request")]
    public partial class UpdateWalletWebhookRequest : IValidatableObject
    {
        ...
        public UpdateWalletWebhookRequest(string url = default, List<string> events = default, string secret = default, Object filters = default)
        {
            this.Url = url;
            this.Events = events;
            this.Secret = secret;

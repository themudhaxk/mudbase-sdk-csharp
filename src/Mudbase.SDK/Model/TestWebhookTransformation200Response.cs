...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "testWebhookTransformation_200_response")]
    public partial class TestWebhookTransformation200Response : IValidatableObject
    {
        ...
        public TestWebhookTransformation200Response(bool success = default, TestWebhookTransformation200ResponseData data = default)
        {
        ...
        public TestWebhookTransformation200ResponseData Data { get; set; }

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateUserAccountStatus_200_response_user")]
    public partial class UpdateUserAccountStatus200ResponseUser : IValidatableObject
    {
        ...
        public UpdateUserAccountStatus200ResponseUser(string id = default, string email = default, string firstName = default, string lastName = default, string accountStatus = default, bool isActive = default)
        {
            this.Id = id;
            this.Email = email;

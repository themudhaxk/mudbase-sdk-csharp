...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "internalCustomDomainAddon_request")]
    public partial class InternalCustomDomainAddonRequest : IValidatableObject
    {
        ...
        protected InternalCustomDomainAddonRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalCustomDomainAddonRequest" /> class.
        /// </summary>
        /// <param name="orgId">orgId (required).</param>
        /// <param name="enabled">enabled (required).</param>
        public InternalCustomDomainAddonRequest(string orgId = default, bool enabled = default)
        {
            // to ensure "orgId" is required (not null)
            if (orgId == null)
            {
                throw new ArgumentNullException("orgId is a required property for InternalCustomDomainAddonRequest and cannot be null");
            }
            this.OrgId = orgId;

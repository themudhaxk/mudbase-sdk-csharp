...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrgSslValidationRecord")]
    public partial class OrgSslValidationRecord : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgSslValidationRecord" /> class.
        /// </summary>
        ...
        public OrgSslValidationRecord(string txtName = default, string txtValue = default, string httpUrl = default, string httpBody = default, string cname = default, string cnameTarget = default)
        {

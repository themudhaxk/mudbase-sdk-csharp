...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrgEdgeHints_ownershipVerification")]
    public partial class OrgEdgeHintsOwnershipVerification : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgEdgeHintsOwnershipVerification" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="type">type.</param>
        /// <param name="value">value.</param>
        public OrgEdgeHintsOwnershipVerification(string name = default, string type = default, string value = default)
        {
            this.Name = name;
            this.Type = type;
            this.Value = value;

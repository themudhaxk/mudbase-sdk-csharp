...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "verifyProjectEmailSmtpDomain_request")]
    public partial class VerifyProjectEmailSmtpDomainRequest : IValidatableObject
    {
        ...
        public VerifyProjectEmailSmtpDomainRequest(string domain = default, string fromEmail = default, bool persist = default)
        {
            this.Domain = domain;

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "convertAnonymousAccount_200_response")]
    public partial class ConvertAnonymousAccount200Response : IValidatableObject
    {
        ...
        public ConvertAnonymousAccount200Response(string message = default, string token = default, string refreshToken = default, int expiresIn = default, User user = default)
        {

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "eraseUserData_409_response")]
    public partial class EraseUserData409Response : IValidatableObject
    {
        ...
        public EraseUserData409Response(string error = default, List<string> soleOwnedOrgs = default)
        {
            this.Error = error;
        ...
        /// </summary>
        [DataMember(Name = "soleOwnedOrgs", EmitDefaultValue = false)]
        public List<string> SoleOwnedOrgs { get; set; }

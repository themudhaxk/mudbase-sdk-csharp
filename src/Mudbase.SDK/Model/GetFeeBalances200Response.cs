...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getFeeBalances_200_response")]
    public partial class GetFeeBalances200Response : IValidatableObject
    {
        ...
        public GetFeeBalances200Response(bool success = default, List<GetFeeBalances200ResponseDataInner> data = default)
        {
        ...
        public List<GetFeeBalances200ResponseDataInner> Data { get; set; }

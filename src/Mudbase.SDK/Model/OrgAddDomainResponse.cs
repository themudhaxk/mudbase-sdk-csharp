...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrgAddDomainResponse")]
    public partial class OrgAddDomainResponse : IValidatableObject
    {
        ...
        protected OrgAddDomainResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgAddDomainResponse" /> class.
        /// </summary>
        ...
        public OrgAddDomainResponse(bool success = default, OrgDomainEntryOrgConsole domain = default, string dnsVerificationInstructions = default)
        {
            this.Success = success;
            // to ensure "domain" is required (not null)
            if (domain == null)
            {
                throw new ArgumentNullException("domain is a required property for OrgAddDomainResponse and cannot be null");
            }
            this.Domain = domain;

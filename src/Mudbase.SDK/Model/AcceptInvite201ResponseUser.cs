...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "acceptInvite_201_response_user")]
    public partial class AcceptInvite201ResponseUser : IValidatableObject
    {
        ...
        public AcceptInvite201ResponseUser(string id = default, string email = default, string firstName = default, string lastName = default, string org = default, string role = default, bool emailVerified = default)
        {
            this.Id = id;
            this.Email = email;

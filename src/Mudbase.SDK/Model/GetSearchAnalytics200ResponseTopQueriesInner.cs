...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getSearchAnalytics_200_response_topQueries_inner")]
    public partial class GetSearchAnalytics200ResponseTopQueriesInner : IValidatableObject
    {
        ...
        public GetSearchAnalytics200ResponseTopQueriesInner(string query = default, int count = default)
        {
            this.Query = query;
            this.Count = count;
        }

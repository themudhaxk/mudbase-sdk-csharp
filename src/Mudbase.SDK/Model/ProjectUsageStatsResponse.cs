...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectUsageStatsResponse")]
    public partial class ProjectUsageStatsResponse : IValidatableObject
    {
        ...
        public ProjectUsageStatsResponse(ProjectUsageStatsResponseProject project = default, ProjectUsage usage = default, string period = default)
        {
        ...
        public ProjectUsageStatsResponseProject Project { get; set; }

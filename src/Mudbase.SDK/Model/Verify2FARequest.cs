...
namespace Mudbase.SDK.Model
{
    ...
    /// Verify2FARequest
    /// </summary>
    [DataContract(Name = "verify2FA_request")]
    public partial class Verify2FARequest : IValidatableObject
    {
        ...
        protected Verify2FARequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Verify2FARequest" /> class.
        /// </summary>
        /// <param name="token">token (required).</param>
        public Verify2FARequest(string token = default)
        {
            // to ensure "token" is required (not null)
            if (token == null)
            {
                throw new ArgumentNullException("token is a required property for Verify2FARequest and cannot be null");
            }
            this.Token = token;
        }

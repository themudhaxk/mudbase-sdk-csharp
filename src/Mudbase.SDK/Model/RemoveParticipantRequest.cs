...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "removeParticipant_request")]
    public partial class RemoveParticipantRequest : IValidatableObject
    {
        ...
        protected RemoveParticipantRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveParticipantRequest" /> class.
        /// </summary>
        /// <param name="userId">userId (required).</param>
        public RemoveParticipantRequest(string userId = default)
        {
            // to ensure "userId" is required (not null)
            if (userId == null)
            {
                throw new ArgumentNullException("userId is a required property for RemoveParticipantRequest and cannot be null");
            }
            this.UserId = userId;
        }

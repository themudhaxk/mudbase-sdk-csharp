...
namespace Mudbase.SDK.Model
{
    ...
    public partial class Project : IValidatableObject
    {
        ...
        public Project(string id = default, string name = default, string description = default, string slug = default, string org = default, AuthConfig auth = default, DatabaseConfig database = default, StorageConfig storage = default, ProjectSettings settings = default, ProjectUsage usage = default, DateTime createdAt = default, DateTime updatedAt = default)
        {
            this.Id = id;
            this.Name = name;

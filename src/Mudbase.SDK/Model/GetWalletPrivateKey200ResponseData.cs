...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getWalletPrivateKey_200_response_data")]
    public partial class GetWalletPrivateKey200ResponseData : IValidatableObject
    {
        ...
        public GetWalletPrivateKey200ResponseData(string walletId = default, string currency = default, string address = default, string privateKey = default, bool isCustomKey = default)
        {

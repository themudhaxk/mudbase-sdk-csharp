...
namespace Mudbase.SDK.Model
{
    ...
    public partial class Collection : IValidatableObject
    {
        ...
        public Collection(string id = default, string name = default, string slug = default, string project = default, List<Field> fields = default, List<Permission> permissions = default, Object settings = default, DateTime createdAt = default, DateTime updatedAt = default)
        {
            this.Id = id;
            this.Name = name;
            this.Slug = slug;

...
namespace Mudbase.SDK.Model
{
    ...
    /// DeviceToken
    /// </summary>
    [DataContract(Name = "DeviceToken")]
    public partial class DeviceToken : IValidatableObject
    {
        /// <summary>
        /// Defines Platform
        /// </summary>
        ...
        public DeviceToken(string token = default, PlatformEnum? platform = default, DateTime lastSeenAt = default, DateTime createdAt = default)
        {
            this.Token = token;

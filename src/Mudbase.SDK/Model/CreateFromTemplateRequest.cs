...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createFromTemplate_request")]
    public partial class CreateFromTemplateRequest : IValidatableObject
    {
        ...
        protected CreateFromTemplateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateFromTemplateRequest" /> class.
        /// </summary>
        ...
        public CreateFromTemplateRequest(string templateId = default, Object credentials = default, string name = default)
        {
            // to ensure "templateId" is required (not null)
            if (templateId == null)
            {
                throw new ArgumentNullException("templateId is a required property for CreateFromTemplateRequest and cannot be null");
            }
            this.TemplateId = templateId;
            // to ensure "credentials" is required (not null)
            if (credentials == null)
            {
                throw new ArgumentNullException("credentials is a required property for CreateFromTemplateRequest and cannot be null");
            }

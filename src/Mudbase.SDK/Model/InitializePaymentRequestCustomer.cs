...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "initializePayment_request_customer")]
    public partial class InitializePaymentRequestCustomer : IValidatableObject
    {
        ...
        protected InitializePaymentRequestCustomer() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InitializePaymentRequestCustomer" /> class.
        /// </summary>
        /// <param name="email">email (required).</param>
        /// <param name="name">name.</param>
        public InitializePaymentRequestCustomer(string email = default, string name = default)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for InitializePaymentRequestCustomer and cannot be null");
            }
            this.Email = email;
            this.Name = name;
        }

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateOrganizationPlan_200_response_oneOf_1")]
    public partial class UpdateOrganizationPlan200ResponseOneOf1 : IValidatableObject
    {
        ...
        public UpdateOrganizationPlan200ResponseOneOf1(string error = default, string message = default)
        {
            this.Error = error;

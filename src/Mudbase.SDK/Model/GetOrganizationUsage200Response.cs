...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getOrganizationUsage_200_response")]
    public partial class GetOrganizationUsage200Response : IValidatableObject
    {
        ...
        public GetOrganizationUsage200Response(Usage usage = default, Limits limits = default, Plan plan = default, Billing billing = default, List<GetOrganizationUsage200ResponseAllOfSuborgsInner> suborgs = default)
        {
            this.Usage = usage;
            this.Limits = limits;
            this.Plan = plan;
        ...
        /// </summary>
        [DataMember(Name = "suborgs", EmitDefaultValue = false)]
        public List<GetOrganizationUsage200ResponseAllOfSuborgsInner> Suborgs { get; set; }

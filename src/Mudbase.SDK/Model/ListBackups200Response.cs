...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listBackups_200_response")]
    public partial class ListBackups200Response : IValidatableObject
    {
        ...
        public ListBackups200Response(List<ListBackups200ResponseBackupsInner> backups = default, int total = default)
        {
        ...
        public List<ListBackups200ResponseBackupsInner> Backups { get; set; }

...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MessageStatsResponse")]
    public partial class MessageStatsResponse : IValidatableObject
    {
        ...
        public MessageStatsResponse(bool success = default, MessageStatsResponseData data = default)
        {
        ...
        public MessageStatsResponseData Data { get; set; }

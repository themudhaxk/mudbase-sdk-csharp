...
namespace Mudbase.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getComplianceSummary_200_response_compliance_security")]
    public partial class GetComplianceSummary200ResponseComplianceSecurity : IValidatableObject
    {
        ...
        public GetComplianceSummary200ResponseComplianceSecurity(string passwordPolicy = default, bool virusScanning = default, bool encryptionAtRest = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "virusScanning", EmitDefaultValue = true)]
        public bool VirusScanning { get; set; }

        /// <summary>
        /// Gets or Sets EncryptionAtRest
        /// </summary>
        [DataMember(Name = "encryptionAtRest", EmitDefaultValue = true)]

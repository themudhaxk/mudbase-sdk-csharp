...
namespace Mudbase.SDK.Test.Api
{
    ...
    public sealed class IntegrationsApiTests : ApiTestsBase
    {
        ...
        /// <summary>
        /// Test IntegrationsExecute
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task IntegrationsExecuteAsyncTest()
        {
            string projectId = default!;
            string integrationId = default!;
            IntegrationsExecuteRequest integrationsExecuteRequest = default!;
            var response = await _instance.IntegrationsExecuteAsync(projectId, integrationId, integrationsExecuteRequest);
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task IntegrationsListAsyncTest()
        {
            string projectId = default!;
            var response = await _instance.IntegrationsListAsync(projectId);
            var model = response.Ok();
            Assert.IsType<IntegrationsList200Response>(model);
        }
    }
}

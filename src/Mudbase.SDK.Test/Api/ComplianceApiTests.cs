...
namespace Mudbase.SDK.Test.Api
{
    ...
    public sealed class ComplianceApiTests : ApiTestsBase
    {
        ...
        /// <summary>
        /// Test ComplianceLogSecurityEvent
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ComplianceLogSecurityEventAsyncTest()
        {
            ComplianceLogSecurityEventRequest complianceLogSecurityEventRequest = default!;
            var response = await _instance.ComplianceLogSecurityEventAsync(complianceLogSecurityEventRequest);
            var model = response.Ok();
            Assert.IsType<ComplianceLogSecurityEvent200Response>(model);
        }
    }
}
